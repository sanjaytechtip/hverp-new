      ...
      <div class="page-content">
        ...
        <div class="panel">
          ...
          <div class="panel-body">
            ...
            <table class="table-bordered table-hover table-striped tbale_header fixed_table table2excel" data-tableName="Test Table 1">
				<thead>
						...
						<tr class="tbale_header text-center">
							...
							@foreach($taskdatas as $taskdata)
								...
								?>
								<th class="bg-info text-white task_left_fix{{ $purple }}">
								{{$taskdata['task_name']}}
         	...
         	$(".exportToExcel").click(function(e){
         		...
         		if(table && table.length){
         			$(table).table2excel({
         				...
         				filename: "po-local-<?php echo date('d-M-Y');?>.xls",
         				fileext: ".xls",
         				exclude_img: true,
         				exclude_links: true,
         				exclude_inputs: true,
