                ...
                <div class="card">
                    <div class="card-body_rename card-body">
                        ...
                        <div class="custom-form-box">
                            <form class="custom-form" action="{{url('admin/edit-vendor/'.$vendor['id'])}}" id="vendors"
                                ...
                                <div class="form-box col1 block_unblock">
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" value="1" @if($vendor['block_unblock']==1) checked
                                                @endif class=" block_unblock " id="" required="" name="block_unblock"
                                                aria-required="true">
                                            Unblock</label>
                                        <label>
                                            <input type="radio" value="2" @if($vendor['block_unblock']==2) checked
                                                @endif class=" block_unblock " id="" required="" name="block_unblock"
                                                aria-required="true">
                                            Block</label>
                                    </div>
                                ...
                                <div class="form-box col1 register_type">
                                    ...
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" value="1" @if($vendor['register_type']==1) checked
                                                @endif class=" register_type " id="" required="" name="register_type"
                                                aria-required="true">
                                            Register</label>
                                        <label>
                                            <input type="radio" value="2" @if($vendor['register_type']==2) checked
                                                @endif class=" register_type " id="" required="" name="register_type"
                                                aria-required="true">
                                            Unregistered</label>
                                    </div>
                                ...
                                <div class="form-box col1 medical_type">
                                    ...
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" value="1" @if($vendor['medical_type']==1) checked @endif
                                                class=" medical_type " id="" required="" name="medical_type"
                                                aria-required="true">
                                            Medical</label>
                                        <label>
                                            <input type="radio" value="2" @if($vendor['medical_type']==2) checked @endif
                                                class=" medical_type " id="" required="" name="medical_type"
                                                aria-required="true">
                                            Non-medical</label>
                                    </div>
                                ...
                                <div class="form-box col1 company_name">
                                    ...
                                    <input onBlur="return uniqueValueCheck(this);" autocomplete="off" type="text"
                                        ...
                                        placeholder="Company Name" value="{{$vendor['company_name']}}" maxlength="50"
                                ...
                                <div class="form-box col1">
                                    ...
                                    <textarea name="h_area" class="form-control h_area " id="" placeholder="Area"
                                        required="" aria-required="true">{{$vendor['h_area']}}</textarea>
                                </div>
                                <div class="form-box col1 h_landmark">
                                    <label for="h_landmark">Landmark</label>
                                    <input autocomplete="off" type="text" name="h_landmark"
                                        class="form-control h_landmark " id="" placeholder="Landmark"
                                        value="{{$vendor['h_landmark']}}" maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 h_country">
                                    ...
                                    <input autocomplete="off" type="text" name="h_country"
                                        class="form-control h_country " id="" placeholder="Country"
                                        value="{{$vendor['h_country']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 h_city">
                                    ...
                                    <input autocomplete="off" type="text" name="h_city" class="form-control h_city "
                                        id="" placeholder="City" value="{{$vendor['h_city']}}" maxlength="50"
                                ...
                                <div class="form-box col2 h_state">
                                    ...
                                    <input autocomplete="off" type="text" name="h_state" class="form-control h_state "
                                        id="" placeholder="State" value="{{$vendor['h_state']}}" maxlength="50"
                                        minlength="2" required="" aria-required="true">
                                </div>
                                <div class="form-box col2 h_pin_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="h_pin_code"
                                        class="form-control h_pin_code " id="" placeholder="Pin Code"
                                        value="{{$vendor['h_pin_code']}}" maxlength="6" minlength="6" required=""
                                        aria-required="true">
                                </div>
                                ...
                                <div class="form-box col1">
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="checkbox" value="1" @if($vendor['same_billing']==1) checked
                                                @endif class=" same_billing " id="copy_head_address"
                                                name="same_billing">
                                ...
                                <div class="form-box col1">
                                    ...
                                    <textarea name="b_area" class="form-control b_area " id="" placeholder="Area"
                                        required="" aria-required="true">{{$vendor['b_area']}}</textarea>
                                </div>
                                <div class="form-box col1 b_landmark">
                                    <label for="b_landmark">Landmark</label>
                                    <input autocomplete="off" type="text" name="b_landmark"
                                        class="form-control b_landmark " id="" placeholder="Landmark"
                                        value="{{$vendor['b_landmark']}}" maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 b_country">
                                    ...
                                    <input autocomplete="off" type="text" name="b_country"
                                        class="form-control b_country " id="" placeholder="Country"
                                        value="{{$vendor['b_country']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 b_city">
                                    ...
                                    <input autocomplete="off" type="text" name="b_city" class="form-control b_city "
                                        id="" placeholder="City" value="{{$vendor['b_city']}}" maxlength="50"
                                        minlength="2" required="" aria-required="true">
                                </div>
                                <div class="form-box col2 b_state">
                                    ...
                                    <input autocomplete="off" type="text" name="b_state" class="form-control b_state "
                                        id="" placeholder="State" value="{{$vendor['b_state']}}" maxlength="50"
                                        minlength="2" required="" aria-required="true">
                                </div>
                                <div class="form-box col2 b_pin_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="b_pin_code"
                                        class="form-control b_pin_code " id="" placeholder="Pin Code"
                                        value="{{$vendor['b_pin_code']}}" maxlength="6" minlength="6" required=""
                                        aria-required="true">
                                </div>
                                ...
                                <div class="form-box col1">
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="checkbox" value="1" @if($vendor['same_shipping']==1) checked
                                                @endif class=" same_shipping " id="copy_shipping_address"
                                                name="same_shipping">
                                ...
                                <div class="form-box col1">
                                    ...
                                    <textarea name="s_area" class="form-control s_area " id="" placeholder="Area"
                                        required="" aria-required="true">{{$vendor['s_area']}}</textarea>
                                </div>
                                <div class="form-box col1 s_landmark">
                                    <label for="s_landmark">Landmark</label>
                                    <input autocomplete="off" type="text" name="s_landmark"
                                        class="form-control s_landmark " id="" placeholder="Landmark"
                                        value="{{$vendor['s_landmark']}}" maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 s_country">
                                    ...
                                    <input autocomplete="off" type="text" name="s_country"
                                        class="form-control s_country " id="" placeholder="Country"
                                        value="{{$vendor['s_country']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 s_city">
                                    ...
                                    <input autocomplete="off" type="text" name="s_city" class="form-control s_city "
                                        id="" placeholder="City" value="{{$vendor['s_city']}}" maxlength="50"
                                        minlength="2" required="" aria-required="true">
                                </div>
                                <div class="form-box col2 s_state">
                                    ...
                                    <input autocomplete="off" type="text" name="s_state" class="form-control s_state "
                                        id="" placeholder="State" value="{{$vendor['s_state']}}" maxlength="50"
                                        minlength="2" required="" aria-required="true">
                                </div>
                                <div class="form-box col2 s_pin_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="s_pin_code"
                                        class="form-control s_pin_code " id="" placeholder="Pin Code"
                                        value="{{$vendor['s_pin_code']}}" maxlength="6" minlength="6" required=""
                                        aria-required="true">
                                </div>
                                ...
                                <div class="form-box col1 s_google_location">
                                    ...
                                    <input autocomplete="off" type="text" name="s_google_location"
                                        ...
                                        value="{{$vendor['s_google_location']}}" maxlength="50" minlength="2">
                                ...
                                @if(!empty($depot_address_data))
                                @foreach($depot_address_data as $key=>$address_data)
                                <input type="hidden" value="{{$address_data['id']}}" name="create_depot_address[{{$key}}][depot_id]">
                                <div class="form-box rows  line_repeat_1" id="rep-{{$key}}">
                                    <div class="form-box col1">
                                        <div class="inline-radio-box inline-radio"><label><input type="checkbox"
                                                    cus="[{{$key}}]" value="1"
                                                    @if($address_data['create_depot_address']) checked @endif
                                                    class=" create_depot_address copy_depot_address" id=""
                                                    name="create_depot_address[{{$key}}][create_depot_address]">Same as
                                                Shipping Address</label></div>
                                    </div>
                                    <div class="form-box col1"><label for="d_area">Area</label><textarea
                                            name="create_depot_address[{{$key}}][d_area]" class="form-control d_area "
                                            id="" placeholder="Area">{{$address_data['d_area']}}</textarea></div>
                                    <div class="form-box col1 d_landmark"><label for="d_landmark">Landmark</label><input
                                            autocomplete="off" type="text"
                                            name="create_depot_address[{{$key}}][d_landmark]"
                                            class="d_landmark-[{{$key}}] form-control d_landmark " id=""
                                            placeholder="Landmark" value="{{$address_data['d_landmark']}}"
                                            maxlength="50" minlength="1"></div>
                                    <div class="form-box col2 d_country"><label for="d_country">Country</label><input
                                            autocomplete="off" type="text"
                                            name="create_depot_address[{{$key}}][d_country]"
                                            class="d_country-[{{$key}}] form-control d_country " id=""
                                            placeholder="Country" value="{{$address_data['d_country']}}" maxlength="50"
                                            minlength="1"></div>
                                    <div class="form-box col2 d_city"><label for="d_city">City</label><input
                                            autocomplete="off" type="text" name="create_depot_address[{{$key}}][d_city]"
                                            class="d_city-[{{$key}}] form-control d_city " id="" placeholder="City"
                                            value="{{$address_data['d_city']}}" maxlength="50" minlength="1"></div>
                                    <div class="form-box col2 d_state"><label for="d_state">State</label><input
                                            autocomplete="off" type="text"
                                            name="create_depot_address[{{$key}}][d_state]"
                                            class="d_state-[{{$key}}] form-control d_state " id="" placeholder="State"
                                            value="{{$address_data['d_state']}}" maxlength="50" minlength="1"></div>
                                    <div class="form-box col2 d_pin_code"><label for="d_pin_code">Pin Code</label><input
                                            ...
                                            class="d_pin_code-[{{$key}}] form-control d_pin_code " id=""
                                            placeholder="Pin Code" value="{{$address_data['d_pin_code']}}" maxlength="6"
                                            minlength="6"></div>
                                </div>
                                @endforeach
                                @else
                                ...
                                <div class="form-box col1 email">
                                    ...
                                    <input autocomplete="off" type="email" cus="email" name="email"
                                        class="form-control email " id="email" placeholder="Email Id"
                                        value="{{$vendor['email']}}" maxlength="50" minlength="6" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col1 website">
                                    <label for="website">Website</label>
                                    <input autocomplete="off" type="url" name="website" class="form-control website "
                                        id="" placeholder="Website" value="{{$vendor['website']}}" maxlength="50"
                                        minlength="6">
                                </div>
                                <div class="form-box col1 contact_number">
                                    <label for="contact_number">Contact Number</label>
                                    <input autocomplete="off" min="0" type="number" name="contact_number"
                                        class="form-control contact_number " id="" placeholder="Contact Number"
                                        value="{{$vendor['contact_number']}}" maxlength="15" minlength="6">
                                </div>
                                <div class="form-box col2 directors_name">
                                    ...
                                    <input autocomplete="off" type="text" name="directors_name"
                                        class="form-control directors_name " id="" placeholder="Directors Name"
                                        value="{{$vendor['directors_name']}}" maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 contact_no">
                                    <label for="contact_no">Contact No</label>
                                    <input autocomplete="off" min="0" type="number" name="contact_no"
                                        class="form-control contact_no " id="" placeholder="Contact No"
                                        value="{{$vendor['contact_no']}}" maxlength="15" minlength="6">
                                </div>
                                <div class="form-box col2 2nd_directors_name">
                                    ...
                                    <input autocomplete="off" type="text" name="2nd_directors_name"
                                        ...
                                        value="{{$vendor['2nd_directors_name']}}" maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 2nd_contact_no">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="2nd_contact_no"
                                        class="form-control 2nd_contact_no " id="" placeholder="Contact No"
                                        value="{{$vendor['2nd_contact_no']}}" maxlength="15" minlength="6">
                                </div>
                                <div class="form-box col2 responsible_emp">
                                    ...
                                    <input autocomplete="off" type="text" name="responsible_emp"
                                        ...
                                        value="{{$vendor['responsible_emp']}}" maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 responsible_contact_no">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="responsible_contact_no"
                                        ...
                                        value="{{$vendor['responsible_contact_no']}}">
                                </div>
                                <div class="form-box col1 GST_number">
                                    <label for="GST_number">GST Number</label>
                                    <input autocomplete="off" type="text" name="GST_number"
                                        class="form-control GST_number " id="" placeholder="GST Number"
                                        value="{{$vendor['GST_number']}}" maxlength="20" minlength="15">
                                </div>
                                <div class="form-box col1 PAN_number">
                                    <label for="PAN_number">PAN Number</label>
                                    <input autocomplete="off" type="text" name="PAN_number"
                                        class="form-control PAN_number " id="" placeholder="PAN Number"
                                        value="{{$vendor['PAN_number']}}" maxlength="10" minlength="10">
                                </div>
                                <div class="form-box col1 TAN_number">
                                    <label for="TAN_number">TAN Number</label>
                                    <input autocomplete="off" type="text" name="TAN_number"
                                        class="form-control TAN_number " id="" placeholder="TAN Number"
                                        value="{{$vendor['TAN_number']}}" maxlength="20" minlength="10">
                                </div>
                                <div class="form-box form-box-heading">Minimum value for FOR</div>
                                
                                    @if(!empty($customer_item_sap_data))
                                    @foreach($customer_item_sap_data as $key1=>$sap_data)
                                    <input type="hidden" value="{{$sap_data['id']}}" name="create_customer_item_sap[{{$key1}}][customer_brand_id]">
                                    <div class="form-box rows  line_repeat_1" id="rep-{{$key1}}">
                                    <div class="form-box col1 create_customer_brand"><label
                                            for="create_customer_brand">Brand</label>
                                    </div>
                                    <div class="form-box col create_customer_item_sap[{{$key1}}][create_customer_brand]">
                                        <select class="form-control" data-plugin="select2"
                                            data-placeholder="Type name" data-minimum-input-length="1"
                                            name="create_customer_item_sap[{{$key1}}][create_customer_brand]">
                                            <option value="">--Select Brand--</option>
                                            @foreach($brand_dataUnit as $brand_unit)
                                            <option @if($sap_data['create_customer_brand']==$brand_unit['brand']) selected @endif value="{{$brand_unit['brand']}}">{{$brand_unit['brand']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-box col1 create_customer_price"><label
                                            for="create_customer_price">Price</label><input autocomplete="off" min="0"
                                            type="number" name="create_customer_item_sap[{{$key1}}][create_customer_price]"
                                            class="create_customer_price-[{{$key1}}] form-control create_customer_price " id=""
                                            placeholder="" value="{{$sap_data['create_customer_price']}}"></div>
                                    </div>
                                    @endforeach
                                    @else
                                    <div class="form-box rows  line_repeat_1" id="rep-0">
                                    ...
                                    <div class="form-box col create_customer_item_sap[0][create_customer_brand]">
                                        <select class="form-control" data-plugin="select2"
                                            data-placeholder="Type name" data-minimum-input-length="1"
                                            name="create_customer_item_sap[0][create_customer_brand]">
                                            <option value="">--Select Brand--</option>
                                            @foreach($brand_dataUnit as $brand_unit)
                                            <option value="{{$brand_unit['brand']}}">{{$brand_unit['brand']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-box col1 create_customer_price"><label
                                ...
                                <div class="form-box col1 advance_required">
                                    ...
                                    <input autocomplete="off" max="100" min="0" type="number" name="advance_required"
                                        ...
                                        value="{{$vendor['advance_required']}}" maxlength="5">
                                </div>
                                <div class="form-box col2 credit_limit">
                                    <label for="credit_limit">Credit Limit</label>
                                    <input autocomplete="off" min="0" type="number" name="credit_limit"
                                        class="form-control credit_limit " id="" placeholder="Credit Limit" value="{{$vendor['credit_limit']}}"
                                        maxlength="7">
                                </div>
                                <div class="form-box col2 credit_days">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="credit_days"
                                        class="form-control credit_days " id="" placeholder="Credit Days" value="{{$vendor['credit_days']}}"
                                ...
                                <div class="form-box col1 state_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="state_code"
                                        class="form-control state_code " id="" placeholder="State Code" value="{{$vendor['state_code']}}"
                                ...
                                <div class="form-box col1 brand"><label for="brand">Brand(s)<span class="required"
                                            ...
                                            <option value="">--Select Brand--</option>
                                            @foreach($brand_dataUnit as $brand_unit)
                                            <option @if($brand_unit['brand']==$vendor['brand']) selected @endif value="{{$brand_unit['brand']}}">{{$brand_unit['brand']}}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                <div class="form-box col1 drug_license_number">
                                    ...
                                    <input autocomplete="off" type="text" name="drug_license_number"
                                        ...
                                        placeholder="Drug License Number" value="{{$vendor['drug_license_number']}}" maxlength="20">
                                </div>
                                ...
                                <div class="form-box col1 bank_account_details">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="bank_account_details"
                                        ...
                                        placeholder="Bank Account Details" value="{{$vendor['bank_account_details']}}" maxlength="16" minlength="9">
                                </div>
                                <div class="form-box col2 bank_account_name">
                                    ...
                                    <input autocomplete="off" type="text" name="bank_account_name"
                                        ...
                                        value="{{$vendor['bank_account_name']}}" maxlength="30">
                                </div>
                                <div class="form-box col2 IFSC_code">
                                    <label for="IFSC_code">IFSC Code</label>
                                    <input autocomplete="off" type="text" name="IFSC_code"
                                        class="form-control IFSC_code " id="" placeholder="IFSC Code" value="{{$vendor['IFSC_code']}}"
                                ...
                                @foreach($department_name as $key2=>$dept_name)
                                <input type="hidden" name="create_departments[{{$key2}}][dept_name_id]" value="{{$dept_name['id']}}">
                                <div class="form-box rows  line_repeat_1" id="rep-{{$key2}}">
                                    <div class="form-box col1 department_name">
                                        <label for="department_name">Department Name</label>
                                        <select class="form-control" data-plugin="select2" data-placeholder="Type name"
                                            data-minimum-input-length="1" name="create_departments[{{$key2}}][department_name]">
                                            <option value="">--Select Department--</option>
                                            @foreach($departments as $department)
                                            <option @if($dept_name['department_name']==$department['id']) selected @endif value="{{$department['id']}}">{{$department['department_name']}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @if(!empty(getDepartmentNameDataVendor($vendor['id'],$dept_name['id'])))
                                    @foreach(getDepartmentNameDataVendor($vendor['id'],$dept_name['id']) as $key3 => $dept_name_data_ven)
                                    <input type="hidden" name="create_departments[{{$key2}}][departments_repeat][{{$key3}}][dept_name_data_id]" value="{{$dept_name_data_ven['id']}}">
                                    <div class="form-box rows line_1">
                                        <div class="form-box col1 name">
                                            <label for="name">Name</label>
                                            <input autocomplete="off" type="text"
                                                name="create_departments[{{$key2}}][departments_repeat][{{$key3}}][name]"
                                                class="form-control name " id="" placeholder="" value="{{$dept_name_data_ven['name']}}" maxlength="50">
                                        </div>
                                        <div class="form-box col1 designation">
                                            <label for="designation">Designation</label>
                                            <select class="form-control" data-plugin="select2"
                                                data-placeholder="Type name" data-minimum-input-length="1"
                                                name="create_departments[{{$key2}}][departments_repeat][{{$key3}}][designation]">
                                                <option value="">--Select Designation--</option>
                                                @foreach($designations as $designation)
                                                <option @if($dept_name_data_ven['designation']==$designation['id']) selected @endif value="{{$designation['id']}}">{{$designation['designation']}}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-box col1 mobile_no">
                                            ...
                                            <input autocomplete="off" min="0" type="number"
                                                name="create_departments[{{$key2}}][departments_repeat][{{$key3}}][mobile_no]"
                                                class="form-control mobile_no " id="" placeholder="" value="{{$dept_name_data_ven['mobile_no']}}"
                                                maxlength="10" minlength="10">
                                        </div>
                                        <div class="form-box col1 email">
                                            <label for="email">Email</label>
                                            <input autocomplete="off" type="text"
                                                name="create_departments[{{$key2}}][departments_repeat][{{$key3}}][email]"
                                                class="form-control email" id="" placeholder="" value="{{$dept_name_data_ven['email']}}">
                                        </div>
                                        <div class="form-box col1 whatsapp_no">
                                            <label for="whatsapp_no">Whatsapp No</label>
                                            <input autocomplete="off" min="0" type="number"
                                                name="create_departments[{{$key2}}][departments_repeat][{{$key3}}][whatsapp_no]"
                                                class="form-control whatsapp_no " id="" placeholder="" value="{{$dept_name_data_ven['whatsapp_no']}}"
                                                maxlength="10" minlength="10">
                                        </div>
                                    </div>
                                    @endforeach
