        ...
        <div class="new-design-inner">
            <div class="new-header-div-fot-btn search-design-data">
                ...
                <div class="payment-heading-box1">
                    <form method="POST" action="{{url('admin/vendor-list')}}" class="custom-inline-form">
                        @csrf
                        <div class="form-box">
                        ...
                        <div class="form-box form-box-submit"><a href="{{route('vendorlist')}}"
                        ...
                        <div class="form-box  form-box-submit">
                            <a class="btn btn-primary waves-effect waves-classic" style="float:right;"
                                href="{{ route('add_vendor') }}"> <i class="icon md-plus" aria-hidden="true"></i>
                                Add</a>
                        </div>
                        ...
                        <div class="form-box form-box-submit"><a class="btn btn-success waves-effect waves-classic small-buton waves-effect waves-classic" href="{{url('admin/export_data_master_vendor/0')}}" title="Export Data"><i class="icon md-download" aria-hidden="true"></i></a></div>
                </div>
                </form>
            </div>
            <div class="page-content">
                ...
                <div class="panel">
                    <div class="panel-body"> @if(!empty($vendor_list))
                        <table class="table table-bordered t1 custom-lineheight-table">
                            ...
                            <tbody id="fb_table_body">
                                @php
                                $i=($vendor_list->currentpage()-1)* $vendor_list->perpage();
                                @endphp
            ...
            <div class="mt-10">{!! $vendor_list->links('pagination::bootstrap-5') !!}</div>
        </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog"> 
    ...
    <div class="modal-content">
      ...
      <form method="post" action="{{url('admin/import_data_master_vendor')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="modal-body col-md-12">
          ...
          <small style="float: right;"><a href="{{url('admin/export_data_master_vendor/1')}}">Download Sample File</a></small>
        </div>
    ...
    $(function(){
                $(document).on('click','.status-update',function(){
                  ...
                  if(id!='' && status!='')
                  {
                    ...
                    var verify = confirm("Are you sure you want to "+type+" this vendor?");
                    if(verify)
                    {
                        $.ajax({
                        url: "{{ url('admin/ajax_vendor_status_update') }}",
                        type: "POST",
