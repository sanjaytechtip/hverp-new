					...
					<tbody id="fb_table_body">
						...
						<tr>
							...
							<td>
							    ...
							    <a href="{{ route('formedit', $form['id']) }}"  title='Form Edit' class="btn btn-pure btn-success icon  waves-effect waves-classic"><i class="icon md-edit" aria-hidden="true"></i> </a>


								<a href="{{ route('viewform',$form['id'])}}" title='Form View' class="btn btn-pure btn-success icon  waves-effect waves-classic"><i class="icon md-eye" aria-hidden="true"></i> </a>

								<a href="{{ route('formpreview',$form['id'])}}"  title='Form Preview' class="btn btn-pure btn-success icon  waves-effect waves-classic"><i class="icon md-assignment" aria-hidden="true"></i> </a>
							...
							<td>
								...
								<a href="{{ route('adddata',$form['id'])}}"  title='Add Data' class="btn btn-pure btn-success icon  waves-effect waves-classic"><i class="icon md-plus" aria-hidden="true"></i> </a>
								
							    								
								<a href="{{ route('listdata',$form['id'])}}"  title='List Data' class="btn btn-pure btn-success icon  waves-effect waves-classic"><i class="icon md-file" aria-hidden="true"></i> </a>
