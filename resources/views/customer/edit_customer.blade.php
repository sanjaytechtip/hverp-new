                ...
                <div class="card">
                    <div class="card-body_rename card-body">
                        ...
                        <div class="custom-form-box">
                            <form class="custom-form" action="{{url('admin/edit-customer/'.$customer['id'])}}" id="customers"
                                ...
                                <div class="form-box col1 block_unblock">
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" value="1" @if($customer['block_unblock']==1) checked @endif class=" block_unblock " id="" required=""
                                                name="block_unblock" aria-required="true">
                                            Unblock</label>
                                        <label>
                                            <input type="radio" value="2" @if($customer['block_unblock']==2) checked @endif class=" block_unblock " id="" required=""
                                                name="block_unblock" aria-required="true">
                                            Block</label>
                                ...
                                <div class="form-box col1 register_type">
                                    ...
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" value="1" @if($customer['register_type']==1) checked @endif class=" register_type " id="" required=""
                                                name="register_type" aria-required="true">
                                            Register</label>
                                        <label>
                                            <input type="radio" value="2" @if($customer['register_type']==2) checked @endif class=" register_type " id="" required=""
                                                name="register_type" aria-required="true">
                                            Unregistered</label>
                                ...
                                <div class="form-box col1 medical_type">
                                    ...
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" value="1" @if($customer['medical_type']==1) checked @endif class=" medical_type " id="" required=""
                                                name="medical_type" aria-required="true">
                                            Medical</label>
                                        <label>
                                            <input type="radio" value="2" @if($customer['medical_type']==2) checked @endif class=" medical_type " id="" required=""
                                                name="medical_type" aria-required="true">
                                            Non-medical</label>
                                ...
                                <div class="form-box col1 medical_type">
                                    ...
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" checked value="0" @if($customer['is_dealer']==0) checked @endif class=" is_dealer " id="" required=""
                                                name="is_dealer" aria-required="true">
                                            No</label>
                                        <label>
                                            <input type="radio" value="1"  @if($customer['is_dealer']==1) checked @endif class=" medical_type " id="" required=""
                                                name="is_dealer" aria-required="true">
                                            Yes</label>
                                ...
                                <div class="form-box col1 company_name">
                                    ...
                                    <input onBlur="return uniqueValueCheck(this);" autocomplete="off" type="text"
                                        ...
                                        placeholder="Company Name" value="{{$customer['company_name']}}" maxlength="50" minlength="4" required=""
                                        aria-required="true">
                                </div>
                                ...
                                <div class="form-box col1">
                                    ...
                                    <textarea name="h_area" class="form-control h_area " id="" placeholder="Area"
                                        required="" aria-required="true">{{$customer['h_area']}}</textarea>
                                </div>
                                <div class="form-box col1 h_landmark">
                                    <label for="h_landmark">Landmark</label>
                                    <input autocomplete="off" type="text" name="h_landmark"
                                        class="form-control h_landmark " id="" placeholder="Landmark" value="{{$customer['h_landmark']}}"
                                ...
                                <div class="form-box col2 h_country">
                                    ...
                                    <input autocomplete="off" type="text" name="h_country"
                                        class="form-control h_country " id="" placeholder="Country" value="{{$customer['h_country']}}"
                                ...
                                <div class="form-box col2 h_city">
                                    ...
                                    <input autocomplete="off" type="text" name="h_city" class="form-control h_city "
                                        id="" placeholder="City" value="{{$customer['h_city']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 h_state">
                                    ...
                                    <input autocomplete="off" type="text" name="h_state" class="form-control h_state "
                                        id="" placeholder="State" value="{{$customer['h_state']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 h_pin_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="h_pin_code"
                                        class="form-control h_pin_code " id="" placeholder="Pin Code" value="{{$customer['h_pin_code']}}"
                                ...
                                <div class="form-box col1">
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="checkbox" value="1" @if($customer['same_billing']==1) checked @endif class=" same_billing "
                                ...
                                <div class="form-box col1">
                                    ...
                                    <textarea name="b_area" class="form-control b_area " id="" placeholder="Area"
                                        required="" aria-required="true">{{$customer['b_area']}}</textarea>
                                </div>
                                <div class="form-box col1 b_landmark">
                                    <label for="b_landmark">Landmark</label>
                                    <input autocomplete="off" type="text" name="b_landmark"
                                        class="form-control b_landmark " id="" placeholder="Landmark" value="{{$customer['b_landmark']}}"
                                        maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 b_country">
                                    ...
                                    <input autocomplete="off" type="text" name="b_country"
                                        class="form-control b_country " id="" placeholder="Country" value="{{$customer['b_country']}}"
                                        maxlength="50" minlength="2" required="" aria-required="true">
                                </div>
                                <div class="form-box col2 b_city">
                                    ...
                                    <input autocomplete="off" type="text" name="b_city" class="form-control b_city "
                                        id="" placeholder="City" value="{{$customer['b_city']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 b_state">
                                    ...
                                    <input autocomplete="off" type="text" name="b_state" class="form-control b_state "
                                        id="" placeholder="State" value="{{$customer['b_state']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 b_pin_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="b_pin_code"
                                        class="form-control b_pin_code " id="" placeholder="Pin Code" value="{{$customer['b_pin_code']}}"
                                        maxlength="6" minlength="6" required="" aria-required="true">
                                </div>
                                    ...
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="checkbox" value="1" class=" same_shipping "
                                                id="copy_shipping_address" @if($customer['same_shipping']==1) checked @endif name="same_shipping">
                                ...
                                <div class="form-box col1">
                                    ...
                                    <textarea name="s_area" class="form-control s_area " id="" placeholder="Area"
                                        required="" aria-required="true">{{$customer['s_area']}}</textarea>
                                </div>
                                <div class="form-box col1 s_landmark">
                                    <label for="s_landmark">Landmark</label>
                                    <input autocomplete="off" type="text" name="s_landmark"
                                        class="form-control s_landmark " id="" placeholder="Landmark" value="{{$customer['s_landmark']}}"
                                        maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 s_country">
                                    ...
                                    <input autocomplete="off" type="text" name="s_country"
                                        class="form-control s_country " id="" placeholder="Country" value="{{$customer['s_country']}}"
                                        maxlength="50" minlength="2" required="" aria-required="true">
                                </div>
                                <div class="form-box col2 s_city">
                                    ...
                                    <input autocomplete="off" type="text" name="s_city" class="form-control s_city "
                                        id="" placeholder="City" value="{{$customer['s_city']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 s_state">
                                    ...
                                    <input autocomplete="off" type="text" name="s_state" class="form-control s_state "
                                        id="" placeholder="State" value="{{$customer['s_state']}}" maxlength="50" minlength="2" required=""
                                        aria-required="true">
                                </div>
                                <div class="form-box col2 s_pin_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="s_pin_code"
                                        class="form-control s_pin_code " id="" placeholder="Pin Code" value="{{$customer['s_pin_code']}}"
                                        maxlength="6" minlength="6" required="" aria-required="true">
                                </div>
                                ...
                                <div class="form-box col1 s_google_location">
                                    ...
                                    <input autocomplete="off" type="text" name="s_google_location"
                                        ...
                                        value="{{$customer['s_google_location']}}" maxlength="50" minlength="2">
                                ...
                                <div class="form-box col1 email">
                                    ...
                                    <input autocomplete="off" type="email" cus="email" name="email"
                                        class="form-control email " id="email" placeholder="Email Id" value="{{$customer['email']}}"
                                ...
                                <div class="form-box col1 website">
                                    ...
                                    <input autocomplete="off" type="url" name="website" class="form-control website "
                                        id="" placeholder="Website" value="{{$customer['website']}}" maxlength="50" minlength="6">
                                </div>
                                <div class="form-box col1 contact_number">
                                    <label for="contact_number">Contact Number</label>
                                    <input autocomplete="off" min="0" type="number" name="contact_number"
                                        class="form-control contact_number " id="" placeholder="Contact Number" value="{{$customer['contact_number']}}"
                                ...
                                <div class="form-box col2 directors_name">
                                    ...
                                    <input autocomplete="off" type="text" name="directors_name"
                                        class="form-control directors_name " id="" placeholder="Directors Name" value="{{$customer['directors_name']}}"
                                        maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 contact_no">
                                    <label for="contact_no">Contact No</label>
                                    <input autocomplete="off" min="0" type="number" name="contact_no"
                                        class="form-control contact_no " id="" placeholder="Contact No" value="{{$customer['contact_no']}}"
                                        maxlength="15" minlength="6">
                                </div>
                                <div class="form-box col2 2nd_directors_name">
                                    ...
                                    <input autocomplete="off" type="text" name="2nd_directors_name"
                                        ...
                                        value="{{$customer['2nd_directors_name']}}" maxlength="50" minlength="2">
                                </div>
                                <div class="form-box col2 2nd_contact_no">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="2nd_contact_no"
                                        class="form-control 2nd_contact_no " id="" placeholder="Contact No" value="{{$customer['2nd_contact_no']}}"
                                        maxlength="15" minlength="6">
                                </div>
                                <div class="form-box col2 responsible_emp">
                                    ...
                                    <input autocomplete="off" type="text" name="responsible_emp"
                                        ...
                                        value="{{$customer['responsible_emp']}}" maxlength="50" minlength="2">
                                </div>
                                ...
                                <div class="form-box col1 TAN_number">
                                    ...
                                    <input autocomplete="off" type="text" name="TAN_number"
                                        class="form-control TAN_number " id="" placeholder="TAN Number" value="{{$customer['TAN_number']}}"
                                ...
                                <div class="form-box col1 advance_required">
                                    ...
                                    <input autocomplete="off" max="100" min="0" type="number" name="advance_required"
                                        ...
                                        value="{{$customer['advance_required']}}" maxlength="5">
                                </div>
                                <div class="form-box col2 credit_limit">
                                    <label for="credit_limit">Credit Limit</label>
                                    <input autocomplete="off" min="0" type="number" name="credit_limit"
                                        class="form-control credit_limit " id="" placeholder="Credit Limit" value="{{$customer['credit_limit']}}"
                                        maxlength="7">
                                </div>
                                <div class="form-box col2 credit_days">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="credit_days"
                                        class="form-control credit_days " id="" placeholder="Credit Days" value="{{$customer['credit_days']}}"
                                ...
                                <div class="form-box col1 state_code">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="state_code"
                                        class="form-control state_code " id="" placeholder="State Code" value="{{$customer['state_code']}}"
                                ...
                                <div class="form-box col1 drug_license_number">
                                    ...
                                    <input autocomplete="off" type="text" name="drug_license_number"
                                        ...
                                        placeholder="Drug License Number" value="{{$customer['drug_license_number']}}" maxlength="20">
                                </div>
                                <div class="form-box col2">
                                    ...
                                    <select class="form-control" data-plugin="select2" data-placeholder="Type name"
                                        ...
                                        <option @if($customer['segment']==$seg['id']) selected @endif value="{{$seg['id']}}">{{$seg['segment']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-box col2 category">
                                    ...
                                    <select class="form-control" data-plugin="select2" data-placeholder="Type name"
                                        ...
                                        <option @if($customer['category']==$customer_cat['id']) selected @endif value="{{$customer_cat['id']}}">{{$customer_cat['category']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-box col1 quotation_invoice_limit">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="quotation_invoice_limit"
                                        ...
                                        placeholder="Quotation &amp; Invoice Limit" value="{{$customer['quotation_invoice_limit']}}" maxlength="50"
                                        minlength="2">
                                </div>
                                <div class="form-box col1 bank_account_details">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="bank_account_details"
                                        ...
                                        placeholder="Bank Account Details" value="{{$customer['bank_account_details']}}" maxlength="16" minlength="9">
                                </div>
                                <div class="form-box col2 bank_account_name">
                                    ...
                                    <input autocomplete="off" type="text" name="bank_account_name"
                                        ...
                                        value="{{$customer['bank_account_name']}}" maxlength="30">
                                </div>
                                <div class="form-box col2 IFSC_code">
                                    <label for="IFSC_code">IFSC Code</label>
                                    <input autocomplete="off" type="text" name="IFSC_code"
                                        class="form-control IFSC_code " id="" placeholder="IFSC Code" value="{{$customer['IFSC_code']}}"
                                ...
                                <div class="form-box col1 choose_process">
                                    ...
                                    <select class="form-control" data-plugin="select2" data-placeholder="Type name"
                                        ...
                                        <option @if($customer['choose_process']==$process['id']) selected @endif value="{{$process['id']}}">{{$process['process']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-box col1 favorite_products">
                                    ...
                                    <select class="form-control favorite_products " id=""
                                        ...
                                        <option @if($customer['favorite_products']=='pro1') selected @endif value="pro1">pro1</option>
                                        <option @if($customer['favorite_products']=='pro2') selected @endif value="pro2">pro2</option>
                                    </select>
                                </div>
                                <div class="form-box col1 add_favorite_products">
                                    ...
                                    <select class="form-control add_favorite_products " id="" placeholder=""
                                        ...
                                        <option value="">--Select--</option>
                                        <option @if($customer['add_favorite_products']=='opt1') selected @endif value="opt1">opt1</option>
                                        <option @if($customer['add_favorite_products']=='opt2') selected @endif value="opt2">opt2</option>
                                    </select>
                                </div>
                                <div class="form-box col1 preference_1">
                                    <label for="preference_1">Preference#1</label>
                                </div>
                                {!! get_preference($data=array('field_id'=>'search','field_name'=>'preference_1'),$edit_data=array('preference_1'=>$customer['preference_1']),'preference_1') !!}

                                <div class="form-box col1 preference_2">
                                    <label for="preference_2">Preference#2</label>
                                </div>
                                {!! get_preference($data=array('field_id'=>'search','field_name'=>'preference_2'),$edit_data=array('preference_2'=>$customer['preference_2']),'preference_2') !!}

                                <div class="form-box col1 preference_3">
                                    <label for="preference_3">Preference#3</label>
                                </div>
                                {!! get_preference($data=array('field_id'=>'search','field_name'=>'preference_3'),$edit_data=array('preference_3'=>$customer['preference_3']),'preference_3') !!}

                                <div class="form-box col1 single_so_single_lot">
                                    <label for="single_so_single_lot">Single SO Single Lot</label>
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" @if($customer['single_so_single_lot']=='yes') checked @endif value="yes" class=" single_so_single_lot " id=""
                                                name="single_so_single_lot">
                                            Yes</label>
                                        <label>
                                            <input type="radio" @if($customer['single_so_single_lot']=='no') checked @endif value="no" class=" single_so_single_lot " id=""
                                                name="single_so_single_lot">
                                            No</label>
                                ...
                                <div class="form-box col1 separate_bills_for_separate_SOs">
                                    ...
                                    <div class="inline-radio-box inline-radio">
                                        <label>
                                            <input type="radio" value="yes" @if($customer['separate_bills_for_separate_SOs']=='yes') checked @endif class=" separate_bills_for_separate_SOs "
                                                id="" name="separate_bills_for_separate_SOs">
                                            Yes</label>
                                        <label>
                                            <input type="radio" value="no" @if($customer['separate_bills_for_separate_SOs']=='no') checked @endif class=" separate_bills_for_separate_SOs "
                                                id="" name="separate_bills_for_separate_SOs">
                                            No</label>
                                ...
                                <div class="form-box col1 payment_terms">
                                    ...
                                    <select class="form-control" data-plugin="select2" data-placeholder="Type name"
                                        ...
                                        <option @if($customer['payment_terms']==$pay_term['id']) selected @endif value="{{$pay_term['id']}}">{{$pay_term['payment_terms']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-box col1 adv_amount">
                                    ...
                                    <input autocomplete="off" min="0" type="number" name="adv_amount"
                                        class="form-control adv_amount " id="" placeholder="Advance Amount (%)" value="{{$customer['adv_amount']}}"
                                ...
                                @foreach($department_name as $key=>$dept_name)
                                <input type="hidden" name="create_departments[{{$key}}][dept_name_id]" value="{{$dept_name['id']}}">
                                <div class="form-box rows  line_repeat_1" id="rep-{{$key}}">
                                    <div class="form-box col1 department_name">
                                        <label for="department_name">Department Name</label>
                                        <select class="form-control" data-plugin="select2" data-placeholder="Type name"
                                            data-minimum-input-length="1" name="create_departments[{{$key}}][department_name]">
                                    ...
                                    @if(!empty(getDepartmentNameData($customer['id'],$dept_name['id'])))
                                    @foreach(getDepartmentNameData($customer['id'],$dept_name['id']) as $key1=>$d_name_data)
                                    <input type="hidden" name="create_departments[{{$key}}][departments_repeat][{{$key1}}][dept_name_data_id]" value="{{$d_name_data['id']}}">
                                    <div class="form-box rows line_1">
                                        <div class="form-box col1 name">
                                            <label for="name">Name</label>
                                            <input autocomplete="off" type="text"
                                                name="create_departments[{{$key}}][departments_repeat][{{$key1}}][name]"
                                                class="form-control name " id="" placeholder="" value="{{$d_name_data['name']}}" maxlength="50">
                                        </div>
                                        <div class="form-box col1 designation">
                                            ...
                                            <select class="form-control" data-plugin="select2"
                                                ...
                                                name="create_departments[{{$key}}][departments_repeat][{{$key1}}][designation]">
                                                <option value="">--Select Designation--</option>
                                                @foreach($designations as $designation)
                                                <option @if($designation['id']==$d_name_data['designation']) selected @endif value="{{$designation['id']}}">{{$designation['designation']}}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-box col1 mobile_no">
                                            ...
                                            <input autocomplete="off" min="0" type="number"
                                                name="create_departments[{{$key}}][departments_repeat][{{$key1}}][mobile_no]"
                                                class="form-control mobile_no " id="" placeholder="" value="{{$d_name_data['mobile_no']}}"
                                                maxlength="10" minlength="10">
                                        </div>
                                        <div class="form-box col1 email">
                                            <label for="email">Email</label>
                                            <input autocomplete="off" type="text"
                                                name="create_departments[{{$key}}][departments_repeat][{{$key1}}][email]"
                                                class="form-control email" id="" placeholder="" value="{{$d_name_data['email']}}">
                                        </div>
                                        <div class="form-box col1 whatsapp_no">
                                            <label for="whatsapp_no">Whatsapp No</label>
                                            <input autocomplete="off" min="0" type="number"
                                                name="create_departments[{{$key}}][departments_repeat][{{$key1}}][whatsapp_no]"
                                                class="form-control whatsapp_no " id="" placeholder="" value="{{$d_name_data['whatsapp_no']}}"
                                                maxlength="10" minlength="10">
                                        </div>
                                    </div>
                                    @endforeach
