...
@section('pageTitle', 'Add Quotation')
@section('pagecontent')
@php
//pr($datalist); die;
@endphp
...
<div class="page creat-fms-box">
  <div class="page-header">
    <h1 class="page-title">{{ __('Add Quotation') }}</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item"><a href="{{ route('quotation_list') }}">Quotation : List</a></li>
      <li class="breadcrumb-item">{{ __('Add Quotation') }}</li>
    </ol>
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
        <form class="" action="{{ url('admin/quotationcreate') }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validateAmount();">
          @csrf
          <div class="card">
          <div class="card-body">
                <div class="row form-new-box-wrap new-quotationcreate new-fix-quotationcreate">
                  <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="row form-three-box">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 ">
                        <label>SrNo.</label>
                        <input type="text" autocomplete="off" value="{{$SrNo}}" id="quotation_srno" name="quotation_srno" required readonly class="form-control">
                      </div>
                      <div class="col-lg-4 col-md-4 col-sm-12 ">
                        <label>No.</label>
                        <input type="text" autocomplete="off" id="quotation_no" readonly name="quotation_no" value="A{{$SrNo}}" class="form-control">
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 new-datecreate">
                    <div class="row form-three-box">
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        <label>Qu. Date</label>
                      <input type="text" autocomplete="off" id="quotation_date" value="{{date('d-m-Y')}}" required class="form-control date_with_time small_field_custom datefield" name="quotation_date">
                      </div>
                      <div class="col-lg-4 col-md-4 col-sm-12 ">
                        <label>Due Date</label>
                      <input type="text" autocomplete="off" id="quotation_due_date" class="form-control date_with_time small_field_custom datefield" name="quotation_due_date">
                      </div>
                      <div class="col-lg-4 col-md-4 col-sm-12 ">
                        <label>Ref. Date</label>
                      <input type="text" autocomplete="off" id="quotation_ref_date" class="form-control date_with_time small_field_custom datefield" name="quotation_ref_date">
                      </div>
                    </div>
                    ...
                    <div class="form-new-box">
                      ...
                      <input name="quotation_ref_no" id="quotation_ref_no" required autocomplete="off" class="form-control" type="text" >
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    <div class="form-new-box">
                      <label>Remarks</label>
                      <textarea name="quotation_remarks" class="form-control"></textarea>
                    </div>
            ...
            <div class="purchaseorder-box quotationcreate-box-wrap">
              <!--<hr />-->
              <label for="contact"><strong>Item Details</strong> <a data-toggle="modal" class="search-quotation-pop-up small-btn  btn-sm btn-primary" href="javascript:void(0);">Search</a></label>
              <br/>
              ...
              <div class="row quotationcreate-wrap">
                ...
                <div class="col-lg-3 col-md-3 form-new-box-wrap">
                  ...
                  <div class="form-new-box">
                    <label>Name</label>
                    <input type="text" autocomplete="off" id="quotation_contact_name" name="quotation_contact_name" required class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Department</label>
                    <input type="text" autocomplete="off" id="quotation_department_name" name="quotation_department_name" required class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Phone</label>
                    <input type="text" autocomplete="off" id="quotation_contact_phone" name="quotation_contact_phone" required class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Email</label>
                    <input type="email" autocomplete="off" id="quotation_contact_email" name="quotation_contact_email" required class="form-control">
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 form-new-box-wrap">
                  <h2>Totals</h2>
                  <div class="form-new-box">
                    ...
                    <input type="text" name="quotation_subtotal" readonly id="sub-total" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Sale Tax</label>
                    <input type="text" autocomplete="off" name="quotation_saletax" id="sale-tax" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Tax Amount</label>
                    <input type="text" autocomplete="off" readonly name="quotation_tax_amount" id="tax-amount" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Grand Total</label>
                    <input type="text" id="grand-total" readonly name="quotation_grand_total" class="form-control">
                  </div>
                </div>
...
<script>
       ...
       var rowCount = $('#editableTable1 >tbody >tr').length;
       if(rowCount>0){
        var verify = confirm("If you change the Customer then below items should be removed. Are you sure want you remove the items?");
        if(verify){
			 ...
			 $("#payment_term option:selected").each(function(){
			  ...
			  if(customer_id!=''){
					...
					success: function(msg){
						//alert(msg); return false;
					data = JSON.parse(msg);
          $('#quotation_due_date').val(data[0].delivery_date);
...
<script>
        $(function(){
           $(document).on('click','.search-quotation-pop-up',function(){
              $("input[name='apply-radio']").prop("checked",false);
