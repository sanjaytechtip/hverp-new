...
td { font-size: 8px; }
  ...
  <table>
    <tr>
      ...
      <td style="text-align:right; border:none; padding:10px; margin:10px; font-size:13px;"><strong>Quotation</strong></td>
    </tr>
    <tr>
      <td width="50%;"><table style="text-align:left; font-size:5px; border:0 none;" border="0">
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Name  :</strong> {{ getCustomerNamefromId($quotation_details['customer_name'])}}</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Address :</strong> {{getCustomerAddress($quotation_details['customer_name'])['h_area']}} @if(getCustomerAddress($quotation_details['customer_name'])['h_landmark']!='') <br>
          ...
          <tr>
            <td style="text-align:left; border:0 none;">{{getCustomerAddress($quotation_details['customer_name'])['h_state']}}, {{getCustomerAddress($quotation_details['customer_name'])['h_country']}} - {{getCustomerAddress($quotation_details['customer_name'])['h_pin_code']}} <span style="display:inline-block; float:right;"><strong>GSTIN No.</strong> {{getCustomerAddress($quotation_details['customer_name'])['GST_number']}}</span></td>
          </tr>
        </table></td>
      <td width="50%;"><table style="text-align:left; font-size:5px; border:0 none;" border="0">
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Quotation No.</strong> {{$quotation_details['quotation_no']}}</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Date</strong> {{date('d-M-Y',strtotime($quotation_details['quotation_date']))}}</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Customer Reference No</strong> {{$quotation_details['quotation_ref_no']}}</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Ref Date</strong> @if($quotation_details['quotation_ref_date']!='1970-01-01'){{ globalDateformatNet($quotation_details['quotation_ref_date'])}} @endif </td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Due Date</strong> @if($quotation_details['quotation_due_date']!='1970-01-01'){{ globalDateformatNet($quotation_details['quotation_due_date'])}} @endif </td>
          </tr>
        </table></td>
    </tr>
    <?php
    ...
    <tr>
      <td style="padding: 0; border: none;" colspan="2"><table style="width:100%; border: none" cellspacing="0" cellpadding="5" border="0">
          <tr>
            ...
            <th rowspan="2" style="font-weight: 600; border-top: none;  width:200px; text-align:left;"><strong>Item Name</strong></th>
            <th rowspan="2" style="font-weight: 600; border-top: none;  width:200px; text-align:left;"><strong>Comment</strong></th>
          ...
          <tr>
            ...
            <td  style="text-align:left;">{{$item_details['comment']}}</td>
            <td  style="text-align:left;">{{$item_details['description']}}</td>
            <td>{{$item_details['hsn_code']}}</td>
            <td>{{$item_details['quantity']}}</td>
            <td  style="">{{$item_details['packing_name']}}</td>
          ...
          @endforeach
          <tr>
            <td style="text-align: right;  border-left:transparent;" colspan="7"><strong>Sale Tax</strong></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td></td>
            <td style="text-align: right;  border-right:transparent;"> {{number_format($quotation_details['quotation_saletax'],2,'.', '')}} </td>
          </tr>
          ...
          <tr>
            ...
            <td></td>
            <td></td>
            <td style="text-align: right; ">{{number_format($quotation_details['quotation_grand_total'],2,'.', '')}}</td>
          </tr>
        </table></td>
    </tr>
    <tr>
