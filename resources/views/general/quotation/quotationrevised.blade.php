...
@section('pageTitle', 'Revise Quotation')
@section('pagecontent')
...
<div class="page creat-fms-box">
  <div class="page-header">
    <h1 class="page-title">{{ __('Revise Quotation') }}</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item"><a href="{{ route('quotation_list') }}">Quotation : List</a></li>
      <li class="breadcrumb-item">{{ __('Revise Quotation') }}</li>
    </ol>
    <div class="page-header-actions custom-page-heading">
      <div class="row no-space w-400">
        <div class="col-sm-6">
          <div class="counter">
          <span class="counter-number font-weight-medium">REVISE DATE</span>
            <div class="counter-label">{{ date('d-m-Y H:i:s',strtotime($quotation_details['revised_date'])) }}</div>
             </div>
        </div>
            ...
            <form class="" action="{{ url('admin/quotation-edit/'.$quotation_details['_id']) }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row form-new-box-wrap">
        ...
        <input readonly required autocomplete="off" value="{{$quotation_details['quotation_status']}}" class="form-control" type="text" >
                  ...
                  <div class="purchaseorder-box quotationcreate-box-wrap">
                    ...
                    <div class="table-wrap big-table">
                      <table class="editable-table table table-striped quotationcreate-table" id="editableTable1">
                        <thead>
                          <tr>
                            <th width="10" class="sl-th">Sl</th>
                            <th width="10" class="vendor-sku-th">Cust Ref No.</th>
                            <th width="50" class="item-th">Item</th>
                        ...
                        <tr id="data-row-{{ $i }}">
                            <td data-text="Sl">{{ $i }}</td>
                            <td data-text="Sl"><input type="text" readonly value="{{$item_details['cust_ref_no']}}" name="row[{{$i}}][cust_ref_no]" class="autocomplete-dynamic cust_ref_no form-control" id="cust_ref_no_rel_{{$i}}" required /></td>
							<td data-text="Item">	
            ...
            <div class="table-box">
              ...
              <thead>
                ...
                <tr id='san-{{$key}}'>
                    ...
                    <td>&nbsp;</td>
                    <input type='hidden' name='other_charges_name[]' value='{{$charges['other_charges_name']}}'><input type='hidden' name='other_charges_val[]' value="{{$charges['other_charges_val']}}" >
                </tr>
                @php
