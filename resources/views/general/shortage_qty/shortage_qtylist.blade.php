...
@section('pageTitle', 'Shortage QTY List')
@section('pagecontent')
    ...
    <div class="new-design-inner">
      <div class="new-header-div-fot-btn search-design-data">
        <div class="page-header">
          <h1 class="page-title">Shortage QTY List</h1>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item">Shortage QTY List</li>
          </ol>
        </div>
        <div class="payment-heading-box1">
        <form method="POST" action="{{url('admin/shortage-qty-list')}}" class="custom-inline-form">
          @csrf
          <div class="form-box">
          ...
          <div class="form-box form-box-submit"><a href="{{route('shortage_qty_list')}}" class="btn btn-primary waves-effect waves-classic" title="Reload" name="reload"><i class="icon md-refresh" aria-hidden="true"></i></a></div>
          </div>
        </form>
      </div>
          ...
          <div class="panel-body"> @if(!empty($stockinwardlist))
            <table class="table table-bordered t1 custom-lineheight-table">
              ...
              <th class="bg-info" id="item_name" style="color:#fff !important;">Item Name</th>
                ...
                <th class="bg-info" id="qty" style="color:#fff !important;">Shortage Qty</th>
