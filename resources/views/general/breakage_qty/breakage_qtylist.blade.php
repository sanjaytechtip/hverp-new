...
@section('pageTitle', 'Breakage QTY List')
@section('pagecontent')
    ...
    <div class="new-design-inner">
      <div class="new-header-div-fot-btn search-design-data">
        <div class="page-header">
          <h1 class="page-title">Breakage QTY List</h1>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item">Breakage QTY List</li>
          </ol>
        </div>
        <div class="payment-heading-box1">
        <form method="POST" action="{{url('admin/breakage-qty-list')}}" class="custom-inline-form">
          @csrf
          <div class="form-box">
          ...
          <div class="form-box form-box-submit"><a href="{{route('breakage_qty_list')}}" class="btn btn-primary waves-effect waves-classic" title="Reload" name="reload"><i class="icon md-refresh" aria-hidden="true"></i></a></div>
          </div>
        </form>
      </div>
          ...
          <div class="panel-body"> @if(!empty($stockinwardlist))
            <table class="table table-bordered t1 custom-lineheight-table">
              ...
              <th class="bg-info" id="item_name" style="color:#fff !important;">Item Name</th>
                ...
                <th class="bg-info" id="qty" style="color:#fff !important;">Breakage Qty</th>
