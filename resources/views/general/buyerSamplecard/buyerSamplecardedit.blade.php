...
@section('pageTitle', 'Edit Buyer Sample Card')
...
<?php 
	$data_status = '';
	if(array_key_exists('data_status', $edit_invoice)){
		$data_status = $edit_invoice['data_status'];
	}
?>

<div class="page creat-fms-box">
	<div class="page-header">
		<h1 class="page-title">{{ __('Edit Buyer Sample Card') }}</h1>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
			<li class="breadcrumb-item"><a href="{{ route('buyersamplecardlisting') }}">Buyer Sample Card Listing</a></li>
			<li class="breadcrumb-item">{{ __('Edit Buyer Sample Card') }}</li>
		</ol>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" name="customer_name" value="{{ $edit_invoice['customer_name'] }}" class="form-control" id="customer_name" />
											<input type="hidden" name="customer_id" value="{{ $edit_invoice['customer_id'] }}" class="form-control" id="customer_id" />
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												...
												<input type="text" name="customer_type" id="customer_type" value="{{ $edit_invoice['customer_type'] }}" class="required form-control">
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												...
												<textarea class="form-control" rows="4" name="address" id="customer_address">{{ $edit_invoice['address'] }}</textarea>
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												...
												<input type="text" name="city" id="city" value="{{ $edit_invoice['city'] }}" class="form-control " />
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												...
												<input type="text" name="name" id="name" value="{{ $edit_invoice['name'] }}" class="form-control" />
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												...
												<input type="text" name="phone" id="phone" value="{{ $edit_invoice['phone'] }}" class="form-control" />
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example auto-complete-div" style="margin-top:10px;">
												...
												<input type="text" name="season" id="season" value="{{ $edit_invoice['season'] }}" class="form-control" />
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												<label for="contact">Email id<span class="required" style="color: #e3342f;">*</span></label>
												<input type="text" name="email" id="email" value="{{ $edit_invoice['email'] }}" class="required form-control" />
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												<label for="contact">Sales Person</label>
												{!! getUserByDesignation(SALES_AGENT,'sales_person','---Select---',$edit_invoice['sales_person']) !!}
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												<label for="contact">Enquiry Type (Sample Card/Quotation)</label>
												<input type="text" name="enquiry_type" id="enquiry_type" value="{{ $edit_invoice['enquiry_type'] }}" class="form-control" />
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="contact-form bs-example" style="margin-top:10px;">
												<label for="contact">CRM Enquiry No</label>
												<input type="text" name="crm_enquery" id="crm_enquery" value="{{ $edit_invoice['crm_enquery'] }}" class="form-control" />
											</div>
											
											<input type="hidden" name="data_status" id="data_status" value="{{ @$edit_invoice['data_status'] }}" />
										</div>
						...
						<div class="table-wrap big-table">
							<table class="editable-table table table-striped" id="editableTable1">
								...
								<tbody id="results">
									...
									<tr id="data-row-{{ $i }}">
										...
										<td data-text="Unit Price"><input type="text" autocomplete="off" min="0" class="form-control width-full unit-price numbers-only" value="{{ $rowData['unit_price'] }}" cus="{{$i}}" rel="unit-price" id="tmp_id_unit_price_{{$i}}" name="row[{{$i}}][unit_price]" />
										</td>
										
										<td data-text="Unit"><input type="text" autocomplete="off" style="width:80px;" class="form-control width-full unit" cus="{{$i}}" rel="unit" id="tmp_id_unit_{{$i}}" name="row[{{$i}}][unit]" value="{{  @$rowData['unit'] }}" />
										</td>
								...
								<div class="add-left">
									<div class="dropdown two-button">
										...
										@if($data_status!=1)
											...
											<a class="dropdown-item add-new-line" cus="5" href="javascript:void(0);">Add 5</a> <a class="dropdown-item add-new-line" cus="10" href="javascript:void(0);">Add 10</a> <a class="dropdown-item add-new-line" cus="20" href="javascript:void(0);">Add 20</a> 
											</div>
										@endif
									</div>
								</div>
										...
										<div class="total-right">
											...
											<div class="subtotal-box">
												<label>Delivery Charges</label>
												 <strong>
												<input type="text" style="width:40% !important; float:right;" value="{{ $edit_invoice['delivery_charge'] }}" class="form-control numbers-only" id="delivery-charge" name="delivery_charge" />
												</strong>
											</div>
							...
							<div class="save-row">
								<div class="save-right float-right">
									<input type="hidden" name="financial_year" value="{{ $edit_invoice['financial_year'] }}" />
