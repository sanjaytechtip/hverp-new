...
<div class="panel-body">
  ...
  <tr>
   ...
   <tr>
    ...
    <td style="text-align:right; border:none; font-size:13px;" valign="middle"><strong>Purchase Order</strong></td>
  </tr>
</table>
</td>
  </tr>
    <tr>
      <td width="50%;"><table style="text-align:left;" cellpadding="5" cellspacing="0" width="100%;" border="0">
          <tr>
            <td style="text-align:left;"><strong>Name :</strong> {{ getCustomerNamefromId($purchaseorder_details['customer_name'])}}</td>
          </tr>
          <tr>
            <td style="text-align:left;"><strong>Address :</strong> {{getCustomerAddress($purchaseorder_details['customer_name'])['h_area']}} @if(getCustomerAddress($purchaseorder_details['customer_name'])['h_landmark']!='') <br>
          ...
          <tr>
            <td style="text-align:left;">{{getCustomerAddress($purchaseorder_details['customer_name'])['h_state']}}, {{getCustomerAddress($purchaseorder_details['customer_name'])['h_country']}} - {{getCustomerAddress($purchaseorder_details['customer_name'])['h_pin_code']}} <span style="display:inline-block; float:right;"><strong>GSTIN No.</strong> {{getCustomerAddress($purchaseorder_details['customer_name'])['GST_number']}}</span></td>
          </tr>
        </table></td>
      <td width="50%;"><table style="text-align:left;" cellpadding="5" cellspacing="0" width="100%;" border="0">
          <tr>
            <td style="text-align:left;"><strong>Purchase Order No.</strong> {{$purchaseorder_details['purchaseorder_no']}}</td>
          </tr>
          <tr>
            <td style="text-align:left;"><strong>PO. Date</strong> {{date('d-M-Y',strtotime($purchaseorder_details['purchaseorder_date']))}}</td>
          </tr>
          <tr>
            <td style="text-align:left;"><strong>Customer Reference No</strong> {{$purchaseorder_details['purchaseorder_ref_no']}}</td>
          </tr>
          <tr>
            <td style="text-align:left;"><strong>Ref Date</strong> @if($purchaseorder_details['purchaseorder_ref_date']!='1970-01-01'){{ globalDateformatNet($purchaseorder_details['purchaseorder_ref_date'])}} @endif </td>
          </tr>
          <tr>
            <td style="text-align:left;"><strong>Delivery Date</strong> @if($purchaseorder_details['purchaseorder_due_date']!='1970-01-01'){{ globalDateformatNet($purchaseorder_details['purchaseorder_due_date'])}} @endif </td>
          </tr>
        </table></td>
    </tr>
    <?php
    ...
    <tr>
      <td style="padding: 0; border: none;" colspan="2"><table style="width:100%; border: none" cellspacing="0" cellpadding="2" border="0">
          ...
          <tr>
            ...
            <td style="text-align:left; border-style: solid solid solid solid; border-width: 1px 1px 1px 1px;">{{$item_details['item_name']}}</td>
          ...
          <tr>
            ...
            <td></td>
            <td></td>
            <td style="text-align: right;"> {{number_format($purchaseorder_details['purchaseorder_saletax'],2,'.', '')}} </td>
          </tr>
			@php
			$sum=0;
			@endphp
          ...
          <tr>
            ...
            <td></td>
            <td></td>
            <td style="text-align: right; font-weight:bold;">{{number_format($purchaseorder_details['purchaseorder_grand_total'],2,'.', '')}}</td>
          </tr>
        </table></td>
    </tr>
    <tr>
