...
@section('pageTitle', 'Revise Sale Order')
@section('pagecontent')
...
<div class="page creat-fms-box">
  <div class="page-header">
    <h1 class="page-title">{{ __('Revise Sale Order') }}</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item"><a href="{{ route('saleorder_list') }}">Sale Order : List</a></li>
      <li class="breadcrumb-item">{{ __('Revise Sale Order') }}</li>
    </ol>
      ...
      <div class="row no-space w-400">
        <div class="col-sm-6">
          ...
          <span class="counter-number font-weight-medium">REVISE DATE</span>
            <div class="counter-label">{{ date('d-m-Y H:i:s',strtotime($saleorder_details['revised_date'])) }}</div>
             </div>
        </div>
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
            <form class="" action="{{ url('admin/saleorder-edit/'.$saleorder_details['_id']) }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();">
              @csrf
              <div class="card">
                <div class="card-body">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 ">
        ...
        <div class="row quotationcreate-wrap">
          <div class="col-lg-6 col-md-6">
            ...
            <div class="table-box">
              ...
              <thead>
                ...
                $sum=0;
                @endphp
                @foreach($saleorder_details['other_charges_name'] as $key=>$charges)
                <tr id='san-{{$key}}'>
                    <td>{{$charges}}</td>
                    <td class='ch-val'>{{$saleorder_details['other_charges_val'][$key]}}</td>
                    <td>&nbsp;</td>
                    <input type='hidden' name='other_charges_name[]' value='{{$charges}}'><input type='hidden' name='other_charges_val[]' value="{{$saleorder_details['other_charges_val'][$key]}}" >
                </tr>
                @php
                $sum = $sum+$saleorder_details['other_charges_val'][$key];
                @endphp
                @endforeach
          ...
          <div class="col-lg-12 quotationcreate-button-wrap">
            ...
            <a href="{{route('saleorder_list')}}" class="btn btn-primary btn-data-save waves-effect waves-classic">Back</a>
