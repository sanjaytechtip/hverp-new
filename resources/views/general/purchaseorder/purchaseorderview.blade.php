...
@section('pageTitle', 'View Purchase Order')
@section('pagecontent')
...
<div class="page creat-fms-box">
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
        <form class="" action="{{ url('admin/purchaseorder-edit/'.$purchaseorder_details['_id']) }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();">
          @csrf
          <div class="card">
          <div class="card-body">
            <div class="row form-new-box-wrap new-quotationcreate new-fix-quotationcreate">
              <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="row form-three-box">
                  <div class="col-lg-4 col-md-4 col-sm-12">
                    <label>Type</label>
                    <input type="text" autocomplete="off" readonly value="{{ $purchaseorder_details['purchaseorder_type']}}" class="form-control">
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    <label>SrNo.</label>
  ...
  <div class="col-lg-4 col-md-4 col-sm-12">
  <label>SO. Date</label>
  <input type="text" autocomplete="off" readonly id="purchaseorder_date" value="{{globalDateformatNet($purchaseorder_details['purchaseorder_date'])}}" required class="form-control small_field_custom" name="purchaseorder_date">
  </div>
  <div class="col-lg-4 col-md-4 col-sm-12 ">
  <label>Delivery Date</label>
  <input type="text" autocomplete="off" readonly id="purchaseorder_due_date" value="@if($purchaseorder_details['purchaseorder_due_date']!='1970-01-01'){{ globalDateformatNet($purchaseorder_details['purchaseorder_due_date'])}} @endif" class="form-control small_field_custom" name="purchaseorder_due_date">
  </div>
  <div class="col-lg-4 col-md-4 col-sm-12 ">
  <label>Ref. Date</label>
  <input type="text" autocomplete="off" readonly id="purchaseorder_ref_date" value="@if($purchaseorder_details['purchaseorder_ref_date']!='1970-01-01'){{ globalDateformatNet($purchaseorder_details['purchaseorder_ref_date'])}} @endif" class="form-control small_field_custom" name="purchaseorder_ref_date">
  </div>
</div>
<div class="row form-three-box">
  <div class="col-lg-6 col-md-6 col-sm-12">
     <label>Priority</label>
     <input type="text" autocomplete="off" readonly value="{{ $purchaseorder_details['purchaseorder_priority']}}" class="form-control">
  </div>
  <div class="col-lg-6 col-md-6 col-sm-12 ">
    <label>Status</label>
    <input readonly required autocomplete="off" value="{{$purchaseorder_details['purchaseorder_status']}}" class="form-control" type="text" >
  </div>
</div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-12 ">
                <div class="form-new-box">
                  <label>Remarks</label>
                  <textarea name="purchaseorder_remarks" readonly class="form-control">{{$purchaseorder_details['purchaseorder_remarks']}}</textarea>
                </div>
            ...
            <div class="purchaseorder-box quotationcreate-box-wrap">
                ...
                <table class="editable-table table table-striped quotationcreate-table left-fix-table" id="editableTable1">
                  <thead>
                    <tr>
                      ...
                      <th width="40" class="remain-qty-th">Remaining Qty</th>
                    </tr>
                  </thead>
                  <tbody id="results">
                  @php
                  ...
                  <tr id="data-row-{{ $i }}">
                    ...
                    <td data-text="Sl" class="task_left_fix"><input type="text" readonly value="{{$item_details['cust_ref_no']}}" name="row[{{$i}}][cust_ref_no]" class="autocomplete-dynamic cust_ref_no form-control" id="cust_ref_no_rel_{{$i}}" required /></td>
                    ...
                    <td data-text="Remaining Qty" align="center">{{$item_details['quantity']-$item_details['inward_qty']}}</td>
                  </tr>
                  @php
                  $i++;
                  @endphp
              ...
              <div class="row quotationcreate-wrap">
                ...
                <div class="col-lg-3 col-md-3 form-new-box-wrap">
                  ...
                  <div class="form-new-box">
                    <label>Name</label>
                    <input type="text" readonly value="{{$purchaseorder_details['purchaseorder_contact_name']}}" required name="purchaseorder_contact_name" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Department</label>
                    <input type="text" readonly value="{{$purchaseorder_details['purchaseorder_contact_department']}}" required name="purchaseorder_contact_department" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Phone</label>
                    <input type="text" readonly value="{{$purchaseorder_details['purchaseorder_contact_phone']}}" required name="purchaseorder_contact_phone" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Email</label>
                    <input type="email" readonly value="{{$purchaseorder_details['purchaseorder_contact_email']}}" required name="purchaseorder_contact_email" class="form-control">
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 form-new-box-wrap">
                  <h2>Totals</h2>
                  ...
                  <div class="form-new-box">
                    ...
                    <input type="text" readonly autocomplete="off" value="{{$purchaseorder_details['purchaseorder_saletax']}}" name="purchaseorder_saletax" id="sale-tax" class="form-control">
                  </div>
                  <div class="form-new-box">
                ...
                <div class="col-lg-12 quotationcreate-button-wrap"> 
                  ...
                  <a href="{{route('purchaseorder_list')}}" class="btn btn-primary btn-data-save waves-effect waves-classic">Back</a> 
...
<script>
	$(function () { 
		...
		$('#customer_name').val('<?php echo $purchaseorder_details['customer_name']; ?>');
