...
<div class="page creat-fms-box">
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
            <form class="" action="{{ url('admin/purchaseordercreate') }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();">
              @csrf
              <div class="card">
                <div class="card-body">
  ...
  <div class="form-new-box">
      <label>Vendor</label>
        <select class="required form-control" id="vendor_name" name="vendor_name" data-plugin="select2" data-placeholder="Type Vendor" data-minimum-input-length="1">
  ...
  <div class="col-lg-4 col-md-4 col-sm-12 ">
  <label>PO. Date</label>
<input type="text" autocomplete="off" id="purchaseorder_date" value="{{date('d-m-Y')}}" required class="form-control date_with_time small_field_custom datefield" name="purchaseorder_date">
  </div>
  <div class="col-lg-4 col-md-4 col-sm-12 ">
  <label>Delivery Date</label>
<input type="text" autocomplete="off" id="purchaseorder_due_date" required class="form-control date_with_time small_field_custom datefield" name="purchaseorder_due_date">
  </div>
  <div class="col-lg-4 col-md-4 col-sm-12 ">
  <label>Ref. Date</label>
<input type="text" autocomplete="off" id="purchaseorder_ref_date" class="form-control date_with_time small_field_custom datefield" name="purchaseorder_ref_date">
  </div>
</div>
...
<div class="row form-three-box">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 ">
        <label>SrNo.</label>
        <input type="text" autocomplete="off" value="{{$SrNo}}" id="purchaseorder_srno" name="purchaseorder_srno" required readonly class="form-control">
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12 ">
        <label>No.</label>
        <input type="text" autocomplete="off" id="purchaseorder_no" readonly name="purchaseorder_no" value="A{{$SrNo}}" class="form-control">
      </div>
    </div>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-12 ">
    <div class="form-new-box">
      <label>Remarks</label>
      <textarea name="purchaseorder_remarks" class="form-control"></textarea>
    </div>
    <div class="row form-three-box">
    <div class="col-lg-4 col-md-4 col-sm-12">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        ...
        <input type="number" id="vendor_adv_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" autocomplete="off" name="vendor_adv_amount" class="form-control" disabled="">
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
      <label>Status</label>
        ...
        <option value="Approved">Approved</option>
                  ...
                  <div class="purchaseorder-box quotationcreate-box-wrap">
                    ...
                    <label for="contact"><strong>Item Details</strong>  <a data-toggle="modal" class="search-quotation-pop-up small-btn  btn-sm btn-primary" href="javascript:void(0);">By Purchase Order</a></label>
                    <br/>
        ...
        <div class="row quotationcreate-wrap">
          <div class="col-lg-6 col-md-6">
            ...
            <div class="table-box">
              ...
              <thead>
                ...
                <tbody>
                <tr id="results-charges"><td><strong>Total</strong></td><td id="total-other"></td><td></td></tr>
                </tbody>
              </table>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 form-new-box-wrap">
            ...
            <div class="form-new-box">
              <label>Name</label>
              <input type="text" autocomplete="off" id="purchaseorder_contact_name" name="purchaseorder_contact_name" required class="form-control">
            </div>
            <div class="form-new-box">
              <label>Department</label>
              <input type="text" autocomplete="off" id="purchaseorder_contact_department" name="purchaseorder_contact_department" required class="form-control">
            </div>
            <div class="form-new-box">
              <label>Phone</label>
              <input type="text" autocomplete="off" id="purchaseorder_contact_phone" name="purchaseorder_contact_phone" required class="form-control">
            </div>
            <div class="form-new-box">
              <label>Email</label>
              <input type="email" autocomplete="off" id="purchaseorder_contact_email" name="purchaseorder_contact_email" required class="form-control">
            </div>
          </div>
          <div class="col-lg-3 col-md-3 form-new-box-wrap">
            <h2>Totals</h2>
            <div class="form-new-box">
              ...
              <input type="text" name="purchaseorder_subtotal" readonly id="sub-total" class="form-control">
            </div>
            <div class="form-new-box">
              <label>Sale Tax</label>
              <input type="text" autocomplete="off" name="purchaseorder_saletax" id="sale-tax" class="form-control">
            </div>
            <div class="form-new-box">
              <label>Tax Amount</label>
              <input type="text" autocomplete="off" readonly name="purchaseorder_tax_amount" id="tax-amount" class="form-control">
            </div>
            <div class="form-new-box">
              <label>Grand Total</label>
              <input type="text" id="grand-total" readonly name="purchaseorder_grand_total" class="form-control">
            </div>
          </div>
        ...
        $(document).on('click','.order_search_purchase',function(){
                ...
                var formulario =  $(".item-form-apply-purchase");
                   ...
                   $('#example-3').pagination({
                    ...
                    var vendor_sku = $("#vendor_sku_purchase").val();
                    var grade = $("#grade_purchase").val();
                    var packing_name = $("#packing_name_purchase").val();
                    
                    $.ajax({
                    url: "{{ url('admin/net_rate_search_purchase') }}" ,
                    type: "POST",
                    data: {page:options.current,brand:brand,name:name,vendor_sku:vendor_sku,grade:grade,packing_name:packing_name},
                    success: function( response ) {
                    //alert(response); return false;
                    if(response!='')
                    {
    ...
    $(function(){
        ...
        $(document).on('click','.btn-apply-purchase',function(){
                ...
                //alert(values); return false;
                    ...
                    type: "POST",
                    data: {vendor_name:vendor_name,values:values,ids:ids,rowCount:rowCount},
                    success: function( response ) {
			 ...
			 $("#payment_term option:selected").each(function(){
			  ...
			  if(customer_id!=''){
			      $.ajax({
					...
					success: function(msg){
						//alert(msg); return false;
					$("#purchaseorder_due_date").val(msg);
    //alert(availableTags);
					}
					});
		  ...
		  $(document).on('change','#vendor_name',function(){
			 ...
			 //alert(customer_id); return false;
			  ...
			  if(vendor_id!=''){
					$.ajax({
					type: "GET",
					url: "{{ url('admin/ajaxVendorDetails')}}/"+vendor_id,
					...
					console.log(data); //return false;
						var availableTags = data;
            $('#vendor_adv_amount').val(data[0].advance_required);
            $('#purchaseorder_due_date').val(data[0].delivery_date);
    //alert(availableTags);
    $( "#purchaseorder_contact_name" ).autocomplete({
      source: availableTags,
      minLength: 1,
