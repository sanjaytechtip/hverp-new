...
@section('pageTitle', 'Add SAP Code Form')
@section('pagecontent')
...
<div class="page formbuilder">
  <div class="page-header">
    <h1 class="page-title">Add SAP Code Form</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item"><a href="{{ route('sapcodelist') }}">SAP Code Form : List</a></li>
      <li class="breadcrumb-item">Add SAP Code Form</li>
    </ol>
  </div>
        ...
        <div class="card">
          <div class="card-body_rename card-body">
            ...
            <div class="custom-form-box">
              <form class="custom-form" action="{{url('admin/add_sapcode_form')}}" id="task_form" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                @csrf
                <div class="form-box rows  line_repeat_1">
                  ...
                  <div class="form-box col2">
                    ...
                    <input type="text" class="form-control" autocomplete="off" required name="sap_code" placeholder="SAP Code">
                  </div>
                </div>
