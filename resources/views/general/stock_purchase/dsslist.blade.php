			...
			<div class="panel-body">
				...
				<table class="table table-bordered table-hover table-striped dataTable no-footer purchase-data-table">
					<thead>
						...
						<th class="bg-info" style="color:#fff !important;">Date | <button type="submit" class="btn btn-success">Search</button> <a href="{{ route('dsslist') }}" > <i class="icon md-refresh" aria-hidden="true"></i> Reset </a></th>
					</thead>
