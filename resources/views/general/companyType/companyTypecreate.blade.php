...
<div class="page creat-fms-box">
	  ...
	  <h2>{{ __('Create Custom Company Type List') }}</h2>
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card">					
                <div class="card-body">
                    <form method="POST" id="" action="{{ route('companyTypeadd') }}">
                        @csrf
						...
						<div id="formsteps" class="form-group col-lg-8 col-md-12">
								<div class="form-group row">
                                    ...
                                    <label for="company_name">{{ __('Company Name') }}</label>
										...
										<div class="error" style="color:#FF0000;">{{ $errors->first('company_name') }}</div>
										@endif
										</div>
								</div>
							...
							<div class="steps_fields  fms-fields-wrap">
								<div class="form-group row" id="step_row_1">
                                   ...
                                   <label>Company Type</label>
									<input type="text" id="label_1" class="form-control" name="row[1][company_type]" value="" onblur="labelSlug(this.id)" required="">
							
								   </div>
								   <input type="hidden" id="label_1_id" class="form-control" name="row[1][company_type_id]" value="">
