...
@section('pageTitle', 'Edit Net rate Form')
@section('pagecontent')
...
<div class="page formbuilder">
	<div class="page-header">
        <h1 class="page-title">Edit Net rate Form</h1>
        <ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
			<li class="breadcrumb-item"><a href="{{ route('netratelist') }}">Net rate Form : List</a></li>
			<li class="breadcrumb-item">Edit Net rate Form</li>
        </ol>
	</div>
			...
			<div class="col-md-12">
				<div class="card">					
					<div class="card-body_rename card-body">					
						<h2 class="form-box form-box-heading">Net rate Form</h2>
