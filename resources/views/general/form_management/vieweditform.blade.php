...
<div class="page creat-fms-box">
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
        <form class="" action="{{ url('admin/formupdate_data/'.$forms[0]['_id']) }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();">
          @csrf
          <div class="card">
            <div class="card-body">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <div class="col">
                      <div class="contact-form bs-example auto-complete-div">
                        ...
                        <input type="text" name="form_name" value="{{$forms[0]['form_name']}}" id="form_name" class="form-control required" />
                      </div>
                    </div>
                    <div class="col">
                      <div class="contact-form bs-example auto-complete-div">
                        <label for="contact">Module Name<span class="required" style="color: #e3342f;">*</span></label>
                        <input class="form-control required" id="module_name" {{ $readonlyField }} value="{{$forms[0]['module_name']}}" name="module_name">
                      </div>
                    </div>
                    <div class="col">
                      <div class="contact-form bs-example auto-complete-div">
                        <label for="contact">Table Name<span class="required" style="color: #e3342f;">*</span></label>
                        <input class="form-control required" id="table_name" {{ $readonlyField }} value="{{$forms[0]['table_name']}}" name="table_name">
                      </div>
                    </div>
                    <div class="col checkbox-wrap">
                      <div class="contact-form bs-example auto-complete-div">
                    <label>&nbsp;</label>                        <label>
                          <input type="checkbox" @if($forms[0]['import']=='import') checked @endif value="import" name="import"  /> Import </label>
                      </div>
                    </div>
                    <div class="col checkbox-wrap">
                      <div class="contact-form bs-example auto-complete-div">
                    <label>&nbsp;</label>
                        <label>
                          <input type="checkbox" @if($forms[0]['export']=='export') checked @endif value="export" name="export_data"  /> Export </label>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="purchaseorder-box">
                  ...
                  <div class="table-wrap big-table">
                    <table class="editable-table table table-striped small-table" id="editableTable1">
                      ...
                      @foreach($forms[0]['row'] as $key=>$rows)
                      <tr id="data-row-{{$key}}">
