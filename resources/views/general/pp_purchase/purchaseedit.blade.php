...
@section('pageTitle', 'Edit Purchase Order Page')
@section('pagecontent')
	...
	<div class="page-content container-fluid">
		<div class="row justify-content-center"> @if (\Session::has('success'))
			...
			<div class="col-md-12">
				...
				?>
				<?php if($partshipped!=''){ ?> 
					<form class="" id="invoiceform" action="{{ url('admin/purchaseupdate_part/'.$edit_purchase_invoice['_id']) }}" method="post" autocomplete="on" onsubmit="return validate();">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 full-form-box">
									<div class="row">
										...
										<div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
											...
											<?php /*?>
											<select class="required form-control" id="transit_time" name="transit_time">
												<option value="">---Select---</option>
										...
										<div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
											...
											<?php /* ?>
											<input type="text" name="pi_reference" id="pi_reference" class="form-control" value="{{ $edit_purchase_invoice['pi_reference'] }}"  /> <?php */?>											
											<?php //$pi_list = getAllPiRefrences();?>
							...
							<div class="purchaseorder-box">
								...
								<div class="table-wrap big-table">
									<table class="editable-table table table-striped" id="editableTable1">
										...
										<?php /*?><input type="text" min="1" class="form-control width-full bulk-qty" cus="{{$i}}" rel="bulk-qty" id="tmp_id_lab_dip_{{$i}}" name="row[{{$i}}][lab_dip_no]" value="{{ $rowData['lab_dip_no'] }}" /><?php */?>
				...
				<select class="form-control width-full select-article" cus="{{$i}}" rel="lab_dip_no" id="tmp_id_lab_dip_{{$i}}" name="row[{{$i}}][lab_dip_no]">
				  ...
				  <option  @if($rowData['lab_dip_no']=='Pending') selected="selected" @endif value="Pending">Pending</option>
												...
												<?php /*?><td data-text="Test Method"><textarea class="form-control width-full" rel="test_method" id="tmp_id_test_method_{{$i}}" style="height:35px;"  name="row[{{$i}}][test_method]">{{ $rowData['test_method'] }}</textarea></td><?php */?>
