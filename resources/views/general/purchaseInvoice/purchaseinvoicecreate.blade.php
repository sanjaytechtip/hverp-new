...
@section('pageTitle', 'Purchase Invoice Page')
...
<div class="page creat-fms-box">
  <div class="page-header">
    <h1 class="page-title">{{ __('Add Proforma Invoice') }}</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item">{{ __('Add Proforma Invoice') }}</li>
    </ol>
      ...
      <div class="row no-space w-400">
        <!--<div class="col-sm-6">
          <div class="counter">
             ...
             <div class="counter-label">PI-POS-1/2020/200020</div></div>
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
            <form class="" action="{{ url('admin/invoiceadd') }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();">
              @csrf
              <div class="card">
                <div class="card-body">
                  <div class="row" style="margin:0;">
                    ...
                    <div class="row">
						...
						<?php /*?>@foreach($customer as $cus)
									<option value="{{ $cus->_id }}">{{ $cus->company_name }}</option>
									@endforeach
									<?php */?>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							...
							<?php */ ?>
							<select name="customer_address" id="customer_address" class="required form-control auto-fill-select">
						...
						<div class="col-lg-6 col-md-6 col-sm-12"> 
							<div class="contact-form bs-example" style="margin-top:10px;">
								...
								<input type="text" name="customer_country" id="customer_country" class="form-control auto-fill-field" />
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="contact-form bs-example" style="margin-top:10px;">
								<label for="contact">City</label>
								<input type="text" name="customer_city" id="customer_city" class="form-control auto-fill-field" />
							</div>
						</div>
                      ...
                      <div class="contact-form bs-example" style="margin-top:10px;">
                        ...
                        <input type="text" name="customer_state" id="customer_state" class="form-control auto-fill-field" />
                      </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="contact-form bs-example" style="margin-top:10px;">
                        <label for="contact">Contact Person</label>
                        <input type="text" name="customer_contact_person" id="customer_contact_person" class="form-control auto-fill-field" />
                      </div>
                      </div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="contact-form bs-example" style="margin-top:10px;">
								<label for="contact">GST No</label>
								<input type="text" name="gst_no" id="gst_no" class="form-control auto-fill-field" />
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="contact-form bs-example" style="margin-top:10px;">
								<label for="contact">Phone</label>
								<input type="text" name="customer_phone" id="customer_phone" class="form-control auto-fill-field" />
							</div>
						</div>
                      </div>
                      </div>
                      ...
                      <div class="contact-form bs-example" style="margin-top:10px;">
                        <label for="contact">Address<span class="required" style="color: #e3342f;">*</span></label>
                        <select name="buyer_address" id="buyer_address" class="required form-control auto-fill-select">
                        <option value="">--- Select Address ---</option>
                        </select>
                      </div>
                      </div>
                      ...
                      <div class="contact-form bs-example" style="margin-top:10px;">
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="contact-form bs-example" style="margin-top:10px;">
								<label for="contact">Country</label>
								<input type="text" name="buyer_country" id="buyer_country" class="form-control auto-fill-field" />
							</div>
						</div>
                      ...
                      <div class="contact-form bs-example" style="margin-top:10px;">
                        <label for="contact">State</label>
                        <input type="text" name="buyer_state" id="buyer_state" class="form-control auto-fill-field" />
                      </div>
                      </div>
                      ...
                      <div class="contact-form bs-example" style="margin-top:10px;">
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="contact-form bs-example" style="margin-top:10px;">
								<label for="contact">GST No</label>
								<input type="text" name="buyer_gst_no" id="buyer_gst_no" class="form-control auto-fill-field" />
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="contact-form bs-example" style="margin-top:10px;">
								<label for="contact">Phone</label>
								<input type="text" name="buyer_phone" id="buyer_phone" class="form-control auto-fill-field" />
							</div>
						</div>
                      </div>
                    </div>
                    ...
                    <div class="contact-form bs-example contact-heading col-lg-12 col-md-12 ">
                      ...
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">Agent/Sales Person Code<span class="required" style="color: #e3342f;">*</span> </label>
                        {!! getUserByDesignation(SALES_AGENT,'sales_agent','---Select---','', 'id="sales_agent"') !!}
                        </div>
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">Brand Name<span class="required" style="color: #e3342f;">*</span> </label> <a href="{{ route('add_brand') }}" target="_blank">Add New Brand</a>
                       {!! getBrandsDropDown('brand_name','---Select---', '') !!} </div>
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">Order Type<span class="required" style="color: #e3342f;">*</span> </label>
                        {!! getOptionDropdown('order_type','order_type', '---Select---', '', 'id="order_type_option"') !!} 
                        </div>
                         <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">Sampling Charge (%)</label>
                        <input type="number" name="order_sampling_type" value="" id="order_sampling_type" class="form-control" />
                        </div>
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">FOB Sample Approval<span class="required" style="color: #e3342f;">*</span></label>
                      ...
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">FPT/ Testing Approval<span class="required" style="color: #e3342f;">*</span></label>
                      ...
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">PAYMENT TERM (Agreed)<span class="required" style="color: #e3342f;">*</span></label>
                        <?php /*?> 
						<input type="text" name="payment_term" id="payment_term" readonly="readonly" class="form-control auto-fill-field" />
						<?php */?>
                      ...
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        ...
                        <input type="text" name="buyer_po_number" value="" class="form-control" />
                      </div>
                      <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
                        <label for="contact">Status<span class="required" style="color: #e3342f;">*</span></label>
						...
						<div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
							...
							<input type="text" name="company_of_transport" class="form-control" />
						</div>
						
						<div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
							<label for="contact">CRM Enquiry No.<span class="required" style="color: #e3342f;">*</span></label>
							<input type="text" name="crm_enquiry_no" class="form-control" required value="" />
						</div>
					  <?php /* ?>
					  <div class="contact-form bs-example col-lg-3 col-md-4" style="margin-top:10px;">
					   ...
					   <?php */ ?>
					   <input type="hidden" name="proforma_invoice_date" value="{{ date('Y-m-d') }}"/>
						<input type="hidden" name="crm_assign" id="crm_assign" value="" />
						<input type="hidden" name="merchant_name" id="merchant_name" value="" />
                        ...
                        <tr id="data-row-{{ $i }}">
							...
							<?php
								...
								foreach($items as $allitems){
									$itemHtml.='<option value="'.$allitems->_id.'">'.$allitems->article_no.'</option>';
								}
							?>
                            <select required class="form-control width-full item select-article" cus="{{$i}}" rel="item" id="tmp_id_item_{{$i}}" name="row[{{$i}}][item]" data-plugin="select2" data-placeholder="Type name" data-minimum-input-length="2">
                            <option value="">-- Select --</option>
								{!! $itemHtml !!}
                            </select>
							<?php */?>
						  ...
						  <?php /*?>
                          <select required class="form-control width-full select-article" cus="{{$i}}" rel="colour" id="tmp_id_colour_{{$i}}" name="row[{{$i}}][colour]">
                           <option value="">--Select--</option>
                           </select>
						   
						   <input type="text" required class="form-control select-article color-field" cus="{{$i}}" rel="colour" id="tmp_id_colour_{{$i}}" name="row[{{$i}}][colour]">
						    <?php */?>
                          ...
                          <td data-text="Bulk Qty"><input type="text" autocomplete="off" required onkeyup="return allCalculateRation(this,{{$i}});" min="0" class="form-control width-full bulk-qty numbers-only" cus="{{$i}}" rel="bulk-qty" id="tmp_id_bulkqty_{{$i}}" name="row[{{$i}}][bulkqty]" /></td>
                          <td data-text="S/S Qty"><input type="text" autocomplete="off" min="0" class="form-control width-full ss-qty numbers-only" cus="{{$i}}" rel="ss-qty" id="tmp_id_ssqty_{{$i}}" name="row[{{$i}}][ssqty]" /></td>
                          ...
                          <td data-text="Lab Dip"><select class="form-control width-full select-article" rel="lab_dip" id="tmp_id_lab_dip_{{$i}}" name="row[{{$i}}][lab_dip]">
                              <option value="Approved">Approved</option>
							  <option value="Required">Required</option>
                            </select></td>
                            </td>
                          <td data-text="ETD"><input type="text" required autocomplete="off" class="form-control width-full etd" cus="{{$i}}" rel="etd" id="tmp_id_etd_{{$i}}" name="row[{{$i}}][etd]" /></td>
                          <td data-text="HSN Code">
                            <input type="text" readonly="readonly" class="form-control width-full item hsn_code select-article" cus="{{$i}}" rel="hsn_code" id="tmp_id_hsn_code_{{$i}}" name="row[{{$i}}][hsn_code]" />
                            </td>
                          <td data-text="Unit Price"><input type="text" autocomplete="off" min="0" required class="form-control width-full unit-price numbers-only" cus="{{$i}}" rel="unit-price" id="tmp_id_unit_price_{{$i}}" name="row[{{$i}}][unit_price]" />
                      ...
                      <div class="add-left">
                        ...
                        <div class="subtotal">
                          <div class="subtotal-box">
                            ...
                            <strong><span id="subtotal">Rs 0.00</span></strong></div>
                            <input type="hidden" class="subtotal" name="subtotal" />
                          <div class="subtotal-box">
                            <label>Sampling Charges</label>
                            <strong><span id="sampling-charge">Rs 0.00</span></strong> </div>
                          ...
                          <div class="subtotal-box">
                            <label>GST</label>
                            <strong><span id="gst-total">Rs 0.00</span></strong> </div>
                            <input type="hidden" class="gsttotal" name="gst" />
                          <div class="subtotal-box grand-total">
                            <label><strong>TOTAL</strong></label>
                            <strong><span id="grandtotal">Rs 0.00</span></strong></div>
...
<script>
  ...
  $(function(){
     $(document).on('change','.item',function(){
		...
		//var total = parseFloat(subTotal)+parseFloat(sampling_charges)+parseFloat(delivery_charge_val)+parseFloat((subTotal*max)/100); 
