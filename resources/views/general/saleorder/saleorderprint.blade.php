...
td { font-size: 8px; }
  ...
  <table>
    <tr>
      ...
      <td style="text-align:right; border:none; padding:10px; margin:10px; font-size:13px;"><strong>Order to Dispatch</strong></td>
    </tr>
    <tr>
      <td width="50%;"><table style="text-align:left; font-size:5px; border:0 none;" border="0">
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Name  :</strong> {{ getCustomerNamefromId($saleorder_details['customer_name'])}}</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Address :</strong> {{getCustomerAddress($saleorder_details['customer_name'])['h_area']}} @if(getCustomerAddress($saleorder_details['customer_name'])['h_landmark']!='') <br>
          ...
          <tr>
            <td style="text-align:left; border:0 none;">{{getCustomerAddress($saleorder_details['customer_name'])['h_state']}}, {{getCustomerAddress($saleorder_details['customer_name'])['h_country']}} - {{getCustomerAddress($saleorder_details['customer_name'])['h_pin_code']}} <span style="display:inline-block; float:right;"><strong>GSTIN No.</strong> {{getCustomerAddress($saleorder_details['customer_name'])['GST_number']}}</span></td>
          </tr>
        </table></td>
      <td width="50%;"><table style="text-align:left; font-size:5px; border:0 none;" border="0">
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Sale Order No.</strong> {{$saleorder_details['saleorder_no']}} @if($saleorder_details['type']==2) (By Replacement Order) @elseif($saleorder_details['type']==3) (By Direct Order) @elseif($saleorder_details['type']==1) (By Quotation Order) @endif</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>So. Date</strong> {{date('d-M-Y',strtotime($saleorder_details['saleorder_date']))}}</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Customer Reference No</strong> {{$saleorder_details['saleorder_ref_no']}}</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Ref Date</strong> @if($saleorder_details['saleorder_ref_date']!='1970-01-01'){{ globalDateformatNet($saleorder_details['saleorder_ref_date'])}} @endif</td>
          </tr>
          <tr>
            <td style="text-align:left; border:0 none;"><strong>Delivery Date</strong> @if($saleorder_details['saleorder_due_date']!='1970-01-01'){{ globalDateformatNet($saleorder_details['saleorder_due_date'])}} @endif</td>
          </tr>
        </table></td>
    </tr>
    <?php
    ...
    <tr>
      <td style="padding: 0; border: none;" colspan="2"><table style="width:100%; border: none" cellspacing="0" cellpadding="5" border="0">
          ...
          <tr>
            ...
            <td></td>
            <td></td>
            <td style="text-align: right;  border-right:transparent;"> {{number_format($saleorder_details['saleorder_saletax'],2,'.', '')}} </td>
          </tr>
