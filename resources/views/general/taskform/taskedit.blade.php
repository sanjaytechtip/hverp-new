...
@section('pageTitle', 'Edit Task Form')
@section('pagecontent')
...
<div class="page formbuilder">
	<div class="page-header">
        <h1 class="page-title">Edit Task Form</h1>
        <ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
			<li class="breadcrumb-item"><a href="{{ route('tasklist') }}">Task Form : List</a></li>
			<li class="breadcrumb-item">Edit Task Form</li>
        </ol>
	</div>
			...
			<div class="col-md-12">
				<div class="card">					
					<div class="card-body_rename card-body">					
						<h2 class="form-box form-box-heading">Task Form</h2>
						<div class="custom-form-box">						
						<form class="custom-form" action="{{url('admin/edit_task/'.$data['_id'])}}" id="task_form" method="POST" enctype="multipart/form-data" novalidate="novalidate">
						@csrf
