...
<div class="page creat-fms-box">
  <div class="page-header">
    <h1 class="page-title">{{ __('Add MRN') }}</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
      <li class="breadcrumb-item"><a href="{{ route('mrn_list') }}">MRN : List</a></li>
      <li class="breadcrumb-item">{{ __('Add MRN') }}</li>
    </ol>
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
        <form class="" action="{{ url('admin/mrncreate') }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();" enctype="multipart/form-data">
          @csrf
          <div class="card">
          <div class="card-body">
            <div class="row form-new-box-wrap new-quotationcreate new-fix-quotationcreate">
              <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="form-new-box">
                  ...
                  <select class="required form-control" id="supplier_name" name="supplier_name" data-plugin="select2" data-placeholder="Type name" data-minimum-input-length="1">
                ...
                <div class="row form-three-box">
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    ...
                    <input type="text" autocomplete="off" value="{{$SrNo}}" id="mrn_receipt_no" name="mrn_receipt_no" required readonly class="form-control">
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    <label>GRN</label>
                    <input type="text" autocomplete="off" id="grn" name="grn" class="form-control">
                  </div>
                </div>
              </div>
              <div class="col-lg-5 col-md-5 col-sm-12">
                <div class="row form-two-box">
                  <div class="col-lg-6 col-md-6 col-sm-12 ">
                    <label>Date</label>
                    <input type="text" autocomplete="off" id="mrn_date" value="{{date('d-m-Y')}}" required class="form-control date_with_time small_field_custom datefield" name="mrn_date">
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 ">
                    <label>Bill Date</label>
                    <input type="text" autocomplete="off" id="mrn_bill_date" value="{{date('d-m-Y')}}" class="form-control date_with_time small_field_custom datefield" name="mrn_bill_date">
                  </div>
                </div>
                <div class="row form-three-box" data-select2-id="578">
                  <div class="col-lg-3 col-md-3 col-sm-12 ">
                    <label>Box Received</label>
                    <input type="number" autocomplete="off" id="box_received" name="box_received" class="form-control">
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-12 ">
                    <label>Box Pending</label>
                    <input type="number" autocomplete="off" id="box_pending" name="box_pending" class="form-control">
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-12 ">
                    <label>Box Dispatched</label>
                    <input type="number" autocomplete="off" id="box_dispatch" name="box_dispatch" class="form-control">
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-12 ">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 ">
                <div class="row form-three-box">
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    <label>Bill No.</label>
                    <input type="text" autocomplete="off" value="" id="mrn_bill_no" name="mrn_bill_no" required class="form-control" aria-required="true" disabled="">
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    <label>Challan No.</label>
                    <input type="text" autocomplete="off" value="" id="mrn_challan_no" name="mrn_challan_no" required class="form-control">
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    <label>E-Way Bill</label>
                    <input type="text" autocomplete="off" value="" id="mrn_eway_bill" name="mrn_eway_bill" class="form-control">
                  </div>
                </div>
                <div class="row form-three-box">
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
                    <label>Remarks</label>
                    <textarea name="mrn_remarks" class="form-control"></textarea>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-12 ">
       ...
       @foreach($transport as $transport_list)                     
                      ...
                      <option value="{{$transport_list['id']}}">{{$transport_list['transport']}}</option>
	   ...
	   @endforeach
            ...
            <div class="purchaseorder-box quotationcreate-box-wrap">
              <label for="contact"><strong>Item Details</strong> <a data-toggle="modal" class="search-purchase-pop-up small-btn   btn-sm btn-primary" href="javascript:void(0);">Search</a> </label>
              <br/>
              ...
              <div class="table-wrap big-table scrollfix-wrap">
                <table class="editable-table table table-striped quotationcreate-table left-fix-table" id="editableTable1">
                  ...
                  <tr class="pur-san" id="data-row-{{ $i }}">
                    <td data-text="Sl" class="task_left_fix"><span class="count-row"></span></td>
                    ...
                    <td data-text="Tax" class="task_left_fix tax-fix-width"><input type="text" name="row[{{$i}}][tax_rate]" cus="{{$i}}" class="autocomplete-dynamic tax_rate form-control" id="tax_rate_rel_{{$i}}" required /></td>
              ...
              <div class="row quotationcreate-wrap justify-content-between">
                ...
                <div class="col-lg-3 col-md-3 form-new-box-wrap">
                  ...
                  <div class="form-new-box">
                    ...
                    <input type="text" name="mrn_subtotal" readonly id="sub-total" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Sale Tax</label>
                    <input type="text" autocomplete="off" readonly name="mrn_tax_amount" id="tax-amount" class="form-control">
                  </div>
                  <div class="form-new-box">
                    <label>Grand Total</label>
                    <input type="text" id="grand-total" readonly name="mrn_grand_total" class="form-control">
                  </div>
                </div>
        ...
        <div class="table-box-popup">
          <table class="table table-bordered editable-table table-striped quotationcreate-table">
            ...
            <tr>
              ...
              <td>{{date('d-m-Y h:i:s',strtotime($podata['created_at']))}}</td>
            </tr>
            @endforeach
              </tbody>
      ...
      $(function(){
          $(document).on('click','.data-append',function(){
            var purchase_id = $('input[type=checkbox]:checked').map(function(_, el) {
                ...
                //   {
                //   var rowCount_d = rowCount.split('-');
                //   var rowCount_d_val = rowCount_d[2];
                //   }
                   //alert(rowCount_d_val);
                    $.ajax({
