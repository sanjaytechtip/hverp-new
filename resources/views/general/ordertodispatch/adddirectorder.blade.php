...
@section('pageTitle', 'Add Direct Order')
@section('pagecontent')
...
<div class="page creat-fms-box">
  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-center"> @if (\Session::has('success'))
      ...
      @endif
      <div class="col-md-12">
        <form class="" action="{{ url('admin/add-direct-order') }}" id='invoiceform' method="post" autocomplete="on" onsubmit="return validate();">
          @csrf
          <div class="card">
          <div class="card-body">
  ...
  <div class="col-lg-4 col-md-4 col-sm-12 ">
    ...
    <div class="">
      <label class="radio-inline"><input type="radio" required checked name="single_order" id="seasonWinter" value="no"> No </label>
      <label class="radio-inline"><input type="radio" required name="single_order" id="seasonSummer" value="yes"> Yes </label>
    </div>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-12 ">
    <label>Advance Amount (%)</label>
    <input value="0" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" autocomplete="off" name="adv_amount" class="form-control" >
  </div>
</div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-12 ">
            ...
            <div class="purchaseorder-box quotationcreate-box-wrap">
                ...
                <table class="editable-table table table-striped quotationcreate-table left-fix-table" id="editableTable1">
                  <thead>
                    <tr>
                      ...
                      <th width="50" class="item-th">Note</th>
                  ...
                  <tr id="data-row-{{ $i }}">
                    ...
                    <td data-text="Item" class="task_left_fix"><input type="text" readonly name="row[{{$i}}][item_name]" class="autocomplete-dynamic form-control" id="itemrel_{{$i}}" required />
                      ...
                      <small><a data-toggle="modal" cus="{{$i}}" class="search-pop-up small-btn" data-target="#myModal" href="javascript:void(0);">Search</a></small></td>
                    <td data-text="Note"><input type="text" name="row[{{$i}}][note]" class="autocomplete-dynamic form-control" id="noterel_{{$i}}" required /></td>
              ...
              <div class="row quotationcreate-wrap">
                ...
                <div class="col-lg-3 col-md-3 form-new-box-wrap">
                  <h2>Direct Order Contact Information</h2>
                  <div class="form-new-box">
                    <label>Name</label>
               ...
               //var quotation_id = $(this).val(); 
                ...
                //alert(quotation_id);
                   ...
                   var rowCount_d_val = $('#tbl_length').val();
                    ...
                    type: "POST",
                    data: {quotation_id:quotation_id,purchase_order_row:purchase_order_row,rowCount_d_val:rowCount_d_val},
                    success: function( response ) {
                    //alert(response); return false;
                    if(response!='')
                    {
                    ...
                    $('#results').append(returnedData.html);    
                     ...
                     $('#saleorder_department_name').val(returnedData.saleorder_contact_department);
